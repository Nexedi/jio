...
return k[2]=b,k[3]=+a>0,k[4]=c,ad.apply(null,k)}function cd(a,b){return void 0===af[a]?!1:void 0===b?af[a]:(af[a]=b,!0)}function dd(a){var b=this.localeData(),c=bd(this,!a,b);return a&&(c=b.pastFuture(+this,c)),b.postformat(c)}function ed(){var a,b,c,d=bf(this._milliseconds)/1e3,e=bf(this._days),f=bf(this._months);a=q(d/60),b=q(a/60),d%=60,a%=60,c=q(f/12),f%=12;var g=c,h=f,i=e,j=b,k=a,l=d,m=this.asSeconds();return m?(0>m?"-":"")+"P"+(g?g+"Y":"")+(h?h+"M":"")+(i?i+"D":"")+(j||k||l?"T":"")+(j?j+"H":"")+(k?k+"M":"")+(l?l+"S":""):"P0D"}var fd,gd;gd=Array.prototype.some?Array.prototype.some:function(a){for(var b=Object(this),c=b.length>>>0,d=0;c>d;d++)if(d in b&&a.call(this,b[d],d,b))return!0;return!1};var hd=a.momentProperties=[],id=!1,jd={};a.suppressDeprecationWarnings=!1,a.deprecationHandler=null;var kd;kd=Object.keys?Object.keys:function(a){var b,c=[];for(b in a)f(a,b)&&c.push(b);return c};var ld,md,nd={},od={},pd=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,qd=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,rd={},sd={},td=/\d/,ud=/\d\d/,vd=/\d{3}/,wd=/\d{4}/,xd=/[+-]?\d{6}/,yd=/\d\d?/,zd=/\d\d\d\d?/,Ad=/\d\d\d\d\d\d?/,Bd=/\d{1,3}/,Cd=/\d{1,4}/,Dd=/[+-]?\d{1,6}/,Ed=/\d+/,Fd=/[+-]?\d+/,Gd=/Z|[+-]\d\d:?\d\d/gi,Hd=/Z|[+-]\d\d(?::?\d\d)?/gi,Id=/[+-]?\d+(\.\d{1,3})?/,Jd=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,Kd={},Ld={},Md=0,Nd=1,Od=2,Pd=3,Qd=4,Rd=5,Sd=6,Td=7,Ud=8;md=Array.prototype.indexOf?Array.prototype.indexOf:function(a){var b;for(b=0;b<this.length;++b)if(this[b]===a)return b;return-1},R("M",["MM",2],"Mo",function(){return this.month()+1}),R("MMM",0,0,function(a){return this.localeData().monthsShort(this,a)}),R("MMMM",0,0,function(a){return this.localeData().months(this,a)}),J("month","M"),W("M",yd),W("MM",yd,ud),W("MMM",function(a,b){return b.monthsShortRegex(a)}),W("MMMM",function(a,b){return b.monthsRegex(a)}),$(["M","MM"],function(a,b){b[Nd]=r(a)-1}),$(["MMM","MMMM"],function(a,b,c,d){var e=c._locale.monthsParse(a,d,c._strict);null!=e?b[Nd]=e:j(c).invalidMonth=a});var Vd=/D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,Wd="January_February_March_April_May_June_July_August_September_October_November_December".split("_"),Xd="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),Yd=Jd,Zd=Jd,$d=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,_d=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,ae=/Z|[+-]\d\d(?::?\d\d)?/,be=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],ce=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],de=/^\/?Date\((\-?\d+)/i;a.createFromInputFallback=u("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(a){a._d=new Date(a._i+(a._useUTC?" UTC":""))}),R("Y",0,0,function(){var a=this.year();return 9999>=a?""+a:"+"+a}),R(0,["YY",2],0,function(){return this.year()%100}),R(0,["YYYY",4],0,"year"),R(0,["YYYYY",5],0,"year"),R(0,["YYYYYY",6,!0],0,"year"),J("year","y"),W("Y",Fd),W("YY",yd,ud),W("YYYY",Cd,wd),W("YYYYY",Dd,xd),W("YYYYYY",Dd,xd),$(["YYYYY","YYYYYY"],Md),$("YYYY",function(b,c){c[Md]=2===b.length?a.parseTwoDigitYear(b):r(b)}),$("YY",function(b,c){c[Md]=a.parseTwoDigitYear(b)}),$("Y",function(a,b){b[Md]=parseInt(a,10)}),a.parseTwoDigitYear=function(a){return r(a)+(r(a)>68?1900:2e3)};var ee=M("FullYear",!0);a.ISO_8601=function(){};var fe=u("moment().min is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(){var a=Ka.apply(null,arguments);return this.isValid()&&a.isValid()?this>a?this:a:l()}),ge=u("moment().max is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(){var a=Ka.apply(null,arguments);return this.isValid()&&a.isValid()?a>this?this:a:l()}),he=function(){return Date.now?Date.now():+new Date};Qa("Z",":"),Qa("ZZ",""),W("Z",Hd),W("ZZ",Hd),$(["Z","ZZ"],function(a,b,c){c._useUTC=!0,c._tzm=Ra(Hd,a)});var ie=/([\+\-]|\d\d)/gi;a.updateOffset=function(){};var je=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/,ke=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;db.fn=Oa.prototype;var le=ib(1,"add"),me=ib(-1,"subtract");a.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",a.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var ne=u("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(a){return void 0===a?this.localeData():this.locale(a)});R(0,["gg",2],0,function(){return this.weekYear()%100}),R(0,["GG",2],0,function(){return this.isoWeekYear()%100}),Pb("gggg","weekYear"),Pb("ggggg","weekYear"),Pb("GGGG","isoWeekYear"),Pb("GGGGG","isoWeekYear"),J("weekYear","gg"),J("isoWeekYear","GG"),W("G",Fd),W("g",Fd),W("GG",yd,ud),W("gg",yd,ud),W("GGGG",Cd,wd),W("gggg",Cd,wd),W("GGGGG",Dd,xd),W("ggggg",Dd,xd),_(["gggg","ggggg","GGGG","GGGGG"],function(a,b,c,d){b[d.substr(0,2)]=r(a)}),_(["gg","GG"],function(b,c,d,e){c[e]=a.parseTwoDigitYear(b)}),R("Q",0,"Qo","quarter"),J("quarter","Q"),W("Q",td),$("Q",function(a,b){b[Nd]=3*(r(a)-1)}),R("w",["ww",2],"wo","week"),R("W",["WW",2],"Wo","isoWeek"),J("week","w"),J("isoWeek","W"),W("w",yd),W("ww",yd,ud),W("W",yd),W("WW",yd,ud),_(["w","ww","W","WW"],function(a,b,c,d){b[d.substr(0,1)]=r(a)});var oe={dow:0,doy:6};R("D",["DD",2],"Do","date"),J("date","D"),W("D",yd),W("DD",yd,ud),W("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient}),$(["D","DD"],Od),$("Do",function(a,b){b[Od]=r(a.match(yd)[0],10)});var pe=M("Date",!0);R("d",0,"do","day"),R("dd",0,0,function(a){return this.localeData().weekdaysMin(this,a)}),R("ddd",0,0,function(a){return this.localeData().weekdaysShort(this,a)}),R("dddd",0,0,function(a){return this.localeData().weekdays(this,a)}),R("e",0,0,"weekday"),R("E",0,0,"isoWeekday"),J("day","d"),J("weekday","e"),J("isoWeekday","E"),W("d",yd),W("e",yd),W("E",yd),W("dd",function(a,b){return b.weekdaysMinRegex(a)}),W("ddd",function(a,b){return b.weekdaysShortRegex(a)}),W("dddd",function(a,b){return b.weekdaysRegex(a)}),_(["dd","ddd","dddd"],function(a,b,c,d){var e=c._locale.weekdaysParse(a,d,c._strict);null!=e?b.d=e:j(c).invalidWeekday=a}),_(["d","e","E"],function(a,b,c,d){b[d]=r(a)});var qe="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),re="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),se="Su_Mo_Tu_We_Th_Fr_Sa".split("_"),te=Jd,ue=Jd,ve=Jd;R("DDD",["DDDD",3],"DDDo","dayOfYear"),J("dayOfYear","DDD"),W("DDD",Bd),W("DDDD",vd),$(["DDD","DDDD"],function(a,b,c){c._dayOfYear=r(a)}),R("H",["HH",2],0,"hour"),R("h",["hh",2],0,oc),R("k",["kk",2],0,pc),R("hmm",0,0,function(){return""+oc.apply(this)+Q(this.minutes(),2)}),R("hmmss",0,0,function(){return""+oc.apply(this)+Q(this.minutes(),2)+Q(this.seconds(),2)}),R("Hmm",0,0,function(){return""+this.hours()+Q(this.minutes(),2)}),R("Hmmss",0,0,function(){return""+this.hours()+Q(this.minutes(),2)+Q(this.seconds(),2)}),qc("a",!0),qc("A",!1),J("hour","h"),W("a",rc),W("A",rc),W("H",yd),W("h",yd),W("HH",yd,ud),W("hh",yd,ud),W("hmm",zd),W("hmmss",Ad),W("Hmm",zd),W("Hmmss",Ad),$(["H","HH"],Pd),$(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a),c._meridiem=a}),$(["h","hh"],function(a,b,c){b[Pd]=r(a),j(c).bigHour=!0}),$("hmm",function(a,b,c){var d=a.length-2;b[Pd]=r(a.substr(0,d)),b[Qd]=r(a.substr(d)),j(c).bigHour=!0}),$("hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[Pd]=r(a.substr(0,d)),b[Qd]=r(a.substr(d,2)),b[Rd]=r(a.substr(e)),j(c).bigHour=!0}),$("Hmm",function(a,b,c){var d=a.length-2;b[Pd]=r(a.substr(0,d)),b[Qd]=r(a.substr(d))}),$("Hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[Pd]=r(a.substr(0,d)),b[Qd]=r(a.substr(d,2)),b[Rd]=r(a.substr(e))});var we=/[ap]\.?m?\.?/i,xe=M("Hours",!0);R("m",["mm",2],0,"minute"),J("minute","m"),W("m",yd),W("mm",yd,ud),$(["m","mm"],Qd);var ye=M("Minutes",!1);R("s",["ss",2],0,"second"),J("second","s"),W("s",yd),W("ss",yd,ud),$(["s","ss"],Rd);var ze=M("Seconds",!1);R("S",0,0,function(){return~~(this.millisecond()/100)}),R(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),R(0,["SSS",3],0,"millisecond"),R(0,["SSSS",4],0,function(){return 10*this.millisecond()}),R(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),R(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),R(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),R(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),R(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),J("millisecond","ms"),W("S",Bd,td),W("SS",Bd,ud),W("SSS",Bd,vd);var Ae;for(Ae="SSSS";Ae.length<=9;Ae+="S")W(Ae,Ed);for(Ae="S";Ae.length<=9;Ae+="S")$(Ae,uc);var Be=M("Milliseconds",!1);R("z",0,0,"zoneAbbr"),R("zz",0,0,"zoneName");var Ce=o.prototype;Ce.add=le,Ce.calendar=kb,Ce.clone=lb,Ce.diff=sb,Ce.endOf=Eb,Ce.format=wb,Ce.from=xb,Ce.fromNow=yb,Ce.to=zb,Ce.toNow=Ab,Ce.get=P,Ce.invalidAt=Nb,Ce.isAfter=mb,Ce.isBefore=nb,Ce.isBetween=ob,Ce.isSame=pb,Ce.isSameOrAfter=qb,Ce.isSameOrBefore=rb,Ce.isValid=Lb,Ce.lang=ne,Ce.locale=Bb,Ce.localeData=Cb,Ce.max=ge,Ce.min=fe,Ce.parsingFlags=Mb,Ce.set=P,Ce.startOf=Db,Ce.subtract=me,Ce.toArray=Ib,Ce.toObject=Jb,Ce.toDate=Hb,Ce.toISOString=vb,Ce.toJSON=Kb,Ce.toString=ub,Ce.unix=Gb,Ce.valueOf=Fb,Ce.creationData=Ob,Ce.year=ee,Ce.isLeapYear=ta,Ce.weekYear=Qb,Ce.isoWeekYear=Rb,Ce.quarter=Ce.quarters=Wb,Ce.month=ha,Ce.daysInMonth=ia,Ce.week=Ce.weeks=$b,Ce.isoWeek=Ce.isoWeeks=_b,Ce.weeksInYear=Tb,Ce.isoWeeksInYear=Sb,Ce.date=pe,Ce.day=Ce.days=gc,Ce.weekday=hc,Ce.isoWeekday=ic,Ce.dayOfYear=nc,Ce.hour=Ce.hours=xe,Ce.minute=Ce.minutes=ye,Ce.second=Ce.seconds=ze,Ce.millisecond=Ce.milliseconds=Be,Ce.utcOffset=Ua,Ce.utc=Wa,Ce.local=Xa,Ce.parseZone=Ya,Ce.hasAlignedHourOffset=Za,Ce.isDST=$a,Ce.isDSTShifted=_a,Ce.isLocal=ab,Ce.isUtcOffset=bb,Ce.isUtc=cb,Ce.isUTC=cb,Ce.zoneAbbr=vc,Ce.zoneName=wc,Ce.dates=u("dates accessor is deprecated. Use date instead.",pe),Ce.months=u("months accessor is deprecated. Use month instead",ha),Ce.years=u("years accessor is deprecated. Use year instead",ee),Ce.zone=u("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779",Va);var De=Ce,Ee={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},Fe={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Ge="Invalid date",He="%d",Ie=/\d{1,2}/,Je={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},Ke=A.prototype;Ke._calendar=Ee,Ke.calendar=zc,Ke._longDateFormat=Fe,Ke.longDateFormat=Ac,Ke._invalidDate=Ge,Ke.invalidDate=Bc,Ke._ordinal=He,Ke.ordinal=Cc,Ke._ordinalParse=Ie,Ke.preparse=Dc,Ke.postformat=Dc,Ke._relativeTime=Je,Ke.relativeTime=Ec,Ke.pastFuture=Fc,Ke.set=y,Ke.months=ca,Ke._months=Wd,Ke.monthsShort=da,Ke._monthsShort=Xd,Ke.monthsParse=fa,Ke._monthsRegex=Zd,Ke.monthsRegex=ka,Ke._monthsShortRegex=Yd,Ke.monthsShortRegex=ja,Ke.week=Xb,Ke._week=oe,Ke.firstDayOfYear=Zb,Ke.firstDayOfWeek=Yb,Ke.weekdays=bc,Ke._weekdays=qe,Ke.weekdaysMin=dc,Ke._weekdaysMin=se,Ke.weekdaysShort=cc,Ke._weekdaysShort=re,Ke.weekdaysParse=fc,Ke._weekdaysRegex=te,Ke.weekdaysRegex=jc,Ke._weekdaysShortRegex=ue,Ke.weekdaysShortRegex=kc,Ke._weekdaysMinRegex=ve,Ke.weekdaysMinRegex=lc,Ke.isPM=sc,Ke._meridiemParse=we,Ke.meridiem=tc,E("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===r(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),a.lang=u("moment.lang is deprecated. Use moment.locale instead.",E),a.langData=u("moment.langData is deprecated. Use moment.localeData instead.",H);var Le=Math.abs,Me=Yc("ms"),Ne=Yc("s"),Oe=Yc("m"),Pe=Yc("h"),Qe=Yc("d"),Re=Yc("w"),Se=Yc("M"),Te=Yc("y"),Ue=$c("milliseconds"),Ve=$c("seconds"),We=$c("minutes"),Xe=$c("hours"),Ye=$c("days"),Ze=$c("months"),$e=$c("years"),_e=Math.round,af={s:45,m:45,h:22,d:26,M:11},bf=Math.abs,cf=Oa.prototype;cf.abs=Oc,cf.add=Qc,cf.subtract=Rc,cf.as=Wc,cf.asMilliseconds=Me,cf.asSeconds=Ne,cf.asMinutes=Oe,cf.asHours=Pe,cf.asDays=Qe,cf.asWeeks=Re,cf.asMonths=Se,cf.asYears=Te,cf.valueOf=Xc,cf._bubble=Tc,cf.get=Zc,cf.milliseconds=Ue,cf.seconds=Ve,cf.minutes=We,cf.hours=Xe,cf.days=Ye,cf.weeks=_c,cf.months=Ze,cf.years=$e,cf.humanize=dd,cf.toISOString=ed,cf.toString=ed,cf.toJSON=ed,cf.locale=Bb,cf.localeData=Cb,cf.toIsoString=u("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",ed),cf.lang=ne,R("X",0,0,"unix"),R("x",0,0,"valueOf"),W("x",Fd),W("X",Id),$("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),$("x",function(a,b,c){c._d=new Date(r(a))}),a.version="2.13.0",b(Ka),a.fn=De,a.min=Ma,a.max=Na,a.now=he,a.utc=h,a.unix=xc,a.months=Jc,a.isDate=d,a.locale=E,a.invalid=l,a.duration=db,a.isMoment=p,a.weekdays=Lc,a.parseZone=yc,a.localeData=H,a.isDuration=Pa,a.monthsShort=Kc,a.weekdaysMin=Nc,a.defineLocale=F,a.updateLocale=G,a.locales=I,a.weekdaysShort=Mc,a.normalizeUnits=K,a.relativeTimeThreshold=cd,a.prototype=De;var df=a;return df}),function(a,b,c){"use strict";function d(a){var b,c=[];if(void 0===a)return void 0;for(Array.isArray(a)||(a=[a]),b=0;b<a.length;b+=1)"object"==typeof a[b]?c[b]=a[b].content:c[b]=a[b];return c}function e(a,b){return function(c,f){var g,h,i,j,k,l,m,n,o,p=b[0][0],q=b[0][1];if("descending"===q)g=1;else{if("ascending"!==q)throw new TypeError("Query.sortFunction(): Argument 2 must be 'ascending' or 'descending'");g=-1}if(void 0!==a&&void 0!==a.key_set&&void 0!==a.key_set[p]&&void 0!==a.key_set[p].cast_to)return h="string"==typeof a.key_set[p].cast_to?a.cast_lookup[a.key_set[p].cast_to]:a.key_set[p].cast_to,m=h(c[p]),n=h(f[p]),"function"==typeof n.cmp?(o=g*n.cmp(m),0!==o?o:b.length>1?e(a,b.slice(1))(c,f):o):m>n?-g:n>m?g:b.length>1?e(a,b.slice(1))(c,f):0;for(k=d(c[p])||[],l=d(f[p])||[],j=Math.max(k.length,l.length),i=0;j>i;i+=1){if(void 0===k[i])return g;if(void 0===l[i])return-g;if(k[i]>l[i])return-g;if(k[i]<l[i])return g}return b.length>1?e(a,b.slice(1))(c,f):0}}function f(a,b,c){if(!Array.isArray(a))throw new TypeError("jioquery.sortOn(): Argument 1 is not of type 'array'");return b.sort(e(c,a)),b}function g(a,b){if(!Array.isArray(a))throw new TypeError("jioquery.limit(): Argument 1 is not of type 'array'");if(!Array.isArray(b))throw new TypeError("jioquery.limit(): Argument 2 is not of type 'array'");return b.splice(0,a[0]),a[1]&&b.splice(a[1]),b}function h(a,b){var c,d,e;if(!Array.isArray(a))throw new TypeError("jioquery.select(): Argument 1 is not of type Array");if(!Array.isArray(b))throw new TypeError("jioquery.select(): Argument 2 is not of type Array");for(c=0;c<b.length;c+=1){for(e={},d=0;d<a.length;d+=1)b[c].hasOwnProperty([a[d]])&&(e[a[d]]=b[c][a[d]]);for(d in e)if(e.hasOwnProperty(d)){b[c]=e;break}}return b}function i(a){var b;if(void 0!==a){if("object"!=typeof a)throw new TypeError("Query().create(): key_schema is not of type 'object'");if(void 0===a.key_set)throw new TypeError("Query().create(): key_schema has no 'key_set' property");for(b in a)if(a.hasOwnProperty(b))switch(b){case"key_set":case"cast_lookup":case"match_lookup":break;default:throw new TypeError("Query().create(): key_schema has unknown property '"+b+"'")}}}function j(a){i(a),this._key_schema=a||{}}function k(){}function l(a){return a.replace(t,"\\$&")}function m(a,b){a.super_=b,a.prototype=Object.create(b.prototype,{constructor:{configurable:!0,enumerable:!1,writable:!0,value:a}})}function n(a,b){if("string"!=typeof a)throw new TypeError("jioquery.searchTextToRegExp(): Argument 1 is not of type 'string'");return b===!1?new RegExp("^"+l(a)+"$"):new RegExp("^"+l(a).replace(u,"[\\s\\S]*").replace(v,".")+"$","i")}function o(a,b){j.call(this,b),this.operator=a.operator,this.query_list=a.query_list||[],this.query_list=this.query_list.map(function(a){return k.create(a,b)})}function p(a){var b=[];if("complex"===a.type)return b.push("("),(a.query_list||[]).forEach(function(c){b.push(p(c)),b.push(a.operator)}),b.length-=1,b.push(")"),b.join(" ");if("simple"===a.type)return(a.key?a.key+": ":"")+(a.operator||"")+' "'+a.value+'"';throw new TypeError("This object is not a query")}function q(a,b){j.call(this,b),this.operator=a.operator,this.key=a.key,this.value=a.value}function r(a){var b;if(void 0===a.read_from)throw new TypeError("Custom key is missing the read_from property");for(b in a)if(a.hasOwnProperty(b))switch(b){case"read_from":case"cast_to":case"equal_match":break;default:throw new TypeError("Custom key has unknown property '"+b+"'")}}var s={},t=/[\-\[\]{}()*+?.,\\\^$|#\s]/g,u=/%/g,v=/_/g,w=/^(?:AND|OR|NOT)$/i,x=/^(?:!?=|<=?|>=?)$/i;j.prototype.exec=function(b,c){if(!Array.isArray(b))throw new TypeError("Query().exec(): Argument 1 is not of type 'array'");if(void 0===c&&(c={}),"object"!=typeof c)throw new TypeError("Query().exec(): Optional argument 2 is not of type 'object'");var d,e=this;for(d=b.length-1;d>=0;d-=1)e.match(b[d])||b.splice(d,1);return c.sort_on&&f(c.sort_on,b,this._key_schema),c.limit&&g(c.limit,b),h(c.select_list||[],b),(new a.Queue).push(function(){return b})},j.prototype.match=function(){return!0},j.prototype.parse=function(b){function c(b,d){function f(a){i.push(function(){return b.parsed=h.query_list[a],c(b,d)}).push(function(){h.query_list[a]=b.parsed})}var g,h=b.parsed,i=new a.Queue;if("complex"===h.type){for(g=0;g<h.query_list.length;g+=1)f(g);return i.push(function(){return b.parsed=h,e.onParseComplexQuery(b,d)})}return"simple"===h.type?e.onParseSimpleQuery(b,d):void 0}var d,e=this;return d={parsed:JSON.parse(JSON.stringify(e.serialized()))},(new a.Queue).push(function(){return e.onParseStart(d,b)}).push(function(){return c(d,b)}).push(function(){return e.onParseEnd(d,b)}).push(function(){return d.parsed})},j.prototype.toString=function(){return""},j.prototype.serialized=function(){return void 0},m(o,j),o.prototype.operator="AND",o.prototype.type="complex",o.prototype.match=function(a){var b=this.operator;return w.test(b)||(b="AND"),this[b.toUpperCase()](a)},o.prototype.toString=function(){var a=[],b=this.operator;return"NOT"===this.operator?(a.push("NOT ("),a.push(this.query_list[0].toString()),a.push(")"),a.join(" ")):(this.query_list.forEach(function(c){a.push("("),a.push(c.toString()),a.push(")"),a.push(b)}),a.length-=1,a.join(" "))},o.prototype.serialized=function(){var a={type:"complex",operator:this.operator,query_list:[]};return this.query_list.forEach(function(b){a.query_list.push("function"==typeof b.toJSON?b.toJSON():b)}),a},o.prototype.toJSON=o.prototype.serialized,o.prototype.AND=function(a){for(var b=!0,c=0;b&&c!==this.query_list.length;)b=this.query_list[c].match(a),c+=1;return b},o.prototype.OR=function(a){for(var b=!1,c=0;!b&&c!==this.query_list.length;)b=this.query_list[c].match(a),c+=1;return b},o.prototype.NOT=function(a){return!this.query_list[0].match(a)},k.create=function(a,b){if(""===a)return new j(b);if("string"==typeof a&&(a=c(a)),"string"==typeof(a||{}).type&&s[a.type])return new s[a.type](a,b);throw new TypeError("QueryFactory.create(): Argument 1 is not a search text or a parsable object")},m(q,j),q.prototype.type="simple",q.prototype.match=function(a){var b,c=null,d=null,e=null,f=null,g=this.operator,h=null,i=this.key;if(x.test(g)||(g=u.test(this.value)?"like":"="),f=this[g],this._key_schema.key_set&&void 0!==this._key_schema.key_set[i]&&(i=this._key_schema.key_set[i]),""===i){f=this.like,h="%"+this.value+"%";for(b in a)if(a.hasOwnProperty(b)&&"__id"!==b&&a[b]&&f(a[b],h)===!0)return!0;return!1}if("object"==typeof i){if(r(i),c=a[i.read_from],d=i.equal_match,"string"==typeof d&&(d=this._key_schema.match_lookup[d]),void 0!==d&&(f="="===g||"like"===g?d:f),h=this.value,e=i.cast_to){"string"==typeof e&&(e=this._key_schema.cast_lookup[e]);try{h=e(h)}catch(j){h=void 0}try{c=e(c)}catch(j){c=void 0}}}else c=a[i],h=this.value;return void 0===c||void 0===h?!1:f(c,h)},q.prototype.toString=function(){return(this.key?this.key+":":"")+(this.operator?" "+this.operator:"")+' "'+this.value+'"'},q.prototype.serialized=function(){var a={type:"simple",key:this.key,value:this.value};return void 0!==this.operator&&(a.operator=this.operator),a},q.prototype.toJSON=q.prototype.serialized,q.prototype["="]=function(a,b){var c,d;for(Array.isArray(a)||(a=[a]),d=0;d<a.length;d+=1){if(c=a[d],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp)return 0===c.cmp(b);if(b.toString()===c.toString())return!0}return!1},q.prototype.like=function(a,b){var c,d;for(Array.isArray(a)||(a=[a]),d=0;d<a.length;d+=1){if(c=a[d],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp)return 0===c.cmp(b);if(n(b.toString()).test(c.toString()))return!0}return!1},q.prototype["!="]=function(a,b){var c,d;for(Array.isArray(a)||(a=[a]),d=0;d<a.length;d+=1){if(c=a[d],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp)return 0!==c.cmp(b);if(b.toString()===c.toString())return!1}return!0},q.prototype["<"]=function(a,b){var c;return Array.isArray(a)||(a=[a]),c=a[0],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp?c.cmp(b)<0:b>c},q.prototype["<="]=function(a,b){var c;return Array.isArray(a)||(a=[a]),c=a[0],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp?c.cmp(b)<=0:b>=c},q.prototype[">"]=function(a,b){var c;return Array.isArray(a)||(a=[a]),c=a[0],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp?c.cmp(b)>0:c>b},q.prototype[">="]=function(a,b){var c;return Array.isArray(a)||(a=[a]),c=a[0],"object"==typeof c&&c.hasOwnProperty("content")&&(c=c.content),"function"==typeof c.cmp?c.cmp(b)>=0:c>=b},s.simple=q,s.complex=o,j.parseStringToObject=c,j.objectToSearchText=p,b.Query=j,b.SimpleQuery=q,b.ComplexQuery=o,b.QueryFactory=k}(RSVP,window,parseStringToObject),function(a,b){"use strict";var c,d="year",e="month",f="day",g="hour",h="minute",i="second",j="millisecond",k={year:0,month:1,day:2,hour:3,minute:4,second:5,millisecond:6},l=function(a,b){return k[a]<k[b]?a:b};c=function(a){if(!(this instanceof c))return new c(a);if(a instanceof c)return this.mom=a.mom.clone(),void(this._precision=a._precision);if(void 0===a)return this.mom=b(),void this.setPrecision(j);if(this.mom=null,this._str=a,a.match(/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+\-][0-2]\d:[0-5]\d|Z)/)||a.match(/\d\d\d\d-\d\d-\d\d \d\d:\d\d:\d\d\.\d\d\d/)?(this.mom=b(a),this.setPrecision(j)):a.match(/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+\-][0-2]\d:[0-5]\d|Z)/)||a.match(/\d\d\d\d-\d\d-\d\d \d\d:\d\d:\d\d/)?(this.mom=b(a),this.setPrecision(i)):a.match(/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+\-][0-2]\d:[0-5]\d|Z)/)||a.match(/\d\d\d\d-\d\d-\d\d \d\d:\d\d/)?(this.mom=b(a),this.setPrecision(h)):a.match(/\d\d\d\d-\d\d-\d\d \d\d/)?(this.mom=b(a),this.setPrecision(g)):a.match(/\d\d\d\d-\d\d-\d\d/)?(this.mom=b(a),this.setPrecision(f)):a.match(/\d\d\d\d-\d\d/)?(this.mom=b(a),this.setPrecision(e)):a.match(/\d\d\d\d/)&&(this.mom=b(a,"YYYY"),this.setPrecision(d)),!this.mom)throw new Error("Cannot parse: "+a)},c.prototype.setPrecision=function(a){this._precision=a},c.prototype.getPrecision=function(){return this._precision},c.prototype.cmp=function(a){var b=this.mom,c=a.mom,d=l(this._precision,a._precision);return b.isBefore(c,d)?-1:b.isSame(c,d)?0:1},c.prototype.toPrecisionString=function(a){var b;if(a=a||this._precision,b={millisecond:"YYYY-MM-DD HH:mm:ss.SSS",second:"YYYY-MM-DD HH:mm:ss",minute:"YYYY-MM-DD HH:mm",hour:"YYYY-MM-DD HH",day:"YYYY-MM-DD",month:"YYYY-MM",year:"YYYY"}[a],!b)throw new TypeError("Unsupported precision value '"+a+"'");return this.mom.format(b)},c.prototype.toString=function(){return this._str},a.jiodate={JIODate:c,YEAR:d,MONTH:e,DAY:f,HOUR:g,MIN:h,SEC:i,MSEC:j}}(window,moment),function(a,b,c,d,e,f,g,h,i,j){"use strict";function k(a,b){if(void 0!==a&&"string"!=typeof a)throw new TypeError("You must pass a string.");this.message=a||"Default Message",this.status_code=b||500}function l(a){var c=new XMLHttpRequest;return new b.Promise(function(b,d,e){var f;if(c.open(a.type||"GET",a.url,!0),c.responseType=a.dataType||"","object"==typeof a.headers&&null!==a.headers)for(f in a.headers)a.headers.hasOwnProperty(f)&&c.setRequestHeader(f,a.headers[f]);if(c.addEventListener("load",function(a){return a.target.status>=400?d(a):void b(a)}),c.addEventListener("error",d),c.addEventListener("progress",e),"object"==typeof a.xhrFields&&null!==a.xhrFields)for(f in a.xhrFields)a.xhrFields.hasOwnProperty(f)&&(c[f]=a.xhrFields[f]);void 0!==a.timeout&&0!==a.timeout&&(c.timeout=a.timeout,c.ontimeout=function(){return d(new w.util.jIOError("Gateway Timeout",504))}),"function"==typeof a.beforeSend&&a.beforeSend(c),c.send(a.data)},function(){c.abort()})}function m(a,c){var d=new g;return new b.Promise(function(b,e,f){d.addEventListener("load",b),d.addEventListener("error",e),d.addEventListener("progress",f),d.readAsText(a,c)},function(){d.abort()})}function n(a){var c=new g;return new b.Promise(function(b,d,e){c.addEventListener("load",b),c.addEventListener("error",d),c.addEventListener("progress",e),c.readAsArrayBuffer(a)},function(){c.abort()})}function o(a){var c=new g;return new b.Promise(function(b,d,e){c.addEventListener("load",b),c.addEventListener("error",d),c.addEventListener("progress",e),c.readAsDataURL(a)},function(){c.abort()})}function p(a){var b,c,d,e,f;if(void 0===a)return void 0;if(null===a)return"null";if(a.constructor===Object){for(c=Object.keys(a).sort(),f=[],d=0;d<c.length;d+=1)b=c[d],e=p(a[b]),void 0!==e&&f.push(p(b)+":"+e);return"{"+f.join(",")+"}"}if(a.constructor===Array){for(f=[],d=0;d<a.length;d+=1)f.push(p(a[d]));return"["+f.join(",")+"]"}return JSON.stringify(a)}function q(a){if("data:"===a)return new c;var b,d=f(a.split(",")[1]),e=a.split(",")[0].split(":")[1],g=new h(d.length),j=new i(g);for(e=e.slice(0,e.length-";base64".length),b=0;b<d.length;b+=1)j[b]=d.charCodeAt(b);return new c([g],{type:e})}function r(a,b,c){if("string"!=typeof a[0]||""===a[0])throw new w.util.jIOError("Document id must be a non empty string on '"+b.__type+"."+c+"'.",400)}function s(a,b,c){if("string"!=typeof a[1]||""===a[1])throw new w.util.jIOError("Attachment id must be a non empty string on '"+b.__type+"."+c+"'.",400)}function t(a,c,d,e){return a.prototype[c]=function(){var a,f=arguments,g=this;return(new b.Queue).push(function(){return void 0!==d?d.apply(g.__storage,[f,g,c]):void 0}).push(function(b){var d=g.__storage[c];if(a=b,void 0===d)throw new w.util.jIOError("Capacity '"+c+"' is not implemented on '"+g.__type+"'",501);return d.apply(g.__storage,f)}).push(function(b){return void 0!==e?e.call(g,f,b,a):b})},this}function u(a,b){return this instanceof u?(this.__type=a,void(this.__storage=b)):new u}function v(){return this instanceof v?void(this.__storage_types={}):new v}void 0===a.openDatabase&&(a.openDatabase=function(){throw new Error("WebSQL is not supported by "+j.userAgent)}),void 0===a.DOMError&&(a.DOMError={});var w,x={};k.prototype=new Error,k.prototype.constructor=k,x.jIOError=k,x.ajax=l,x.readBlobAsText=m,x.readBlobAsArrayBuffer=n,x.readBlobAsDataURL=o,x.stringify=p,x.dataURItoBlob=q,t(u,"put",r,function(a){return a[0]}),t(u,"get",r),t(u,"bulk"),t(u,"remove",r,function(a){return a[0]}),u.prototype.post=function(){var a=this,c=arguments;return(new b.Queue).push(function(){var b=a.__storage.post;if(void 0===b)throw new w.util.jIOError("Capacity 'post' is not implemented on '"+a.__type+"'",501);return a.__storage.post.apply(a.__storage,c)})},t(u,"putAttachment",function(a,b,d){r(a,b,d),s(a,b,d);var e=a[3]||{};if("string"==typeof a[2])a[2]=new c([a[2]],{type:e._content_type||e._mimetype||"text/plain;charset=utf-8"});else if(!(a[2]instanceof c))throw new w.util.jIOError("Attachment content is not a blob",400)}),t(u,"removeAttachment",function(a,b,c){r(a,b,c),s(a,b,c)}),t(u,"getAttachment",function(a,b,c){var d="blob";return r(a,b,c),s(a,b,c),void 0!==a[2]&&(d=a[2].format||d,delete a[2].format),d},function(a,d,e){var f;if(!(d instanceof c))throw new w.util.jIOError("'getAttachment' ("+a[0]+" , "+a[1]+") on '"+this.__type+"' does not return a Blob.",501);if("blob"===e)f=d;else if("data_url"===e)f=(new b.Queue).push(function(){return w.util.readBlobAsDataURL(d)}).push(function(a){return a.target.result});else if("array_buffer"===e)f=(new b.Queue).push(function(){return w.util.readBlobAsArrayBuffer(d)}).push(function(a){return a.target.result});else if("text"===e)f=(new b.Queue).push(function(){return w.util.readBlobAsText(d)}).push(function(a){return a.target.result});else{if("json"!==e)throw new w.util.jIOError(this.__type+".getAttachment format: '"+e+"' is not supported",400);f=(new b.Queue).push(function(){return w.util.readBlobAsText(d)}).push(function(a){return JSON.parse(a.target.result)})}return f}),u.prototype.buildQuery=function(){var a=this.__storage.buildQuery,c=this,d=arguments;if(void 0===a)throw new w.util.jIOError("Capacity 'buildQuery' is not implemented on '"+this.__type+"'",501);return(new b.Queue).push(function(){return a.apply(c.__storage,d)})},u.prototype.hasCapacity=function(a){var b=this.__storage.hasCapacity,c=this.__storage[a];if(void 0!==c)return!0;if(void 0===b||!b.apply(this.__storage,arguments))throw new w.util.jIOError("Capacity '"+a+"' is not implemented on '"+this.__type+"'",501);return!0},u.prototype.allDocs=function(a){var c=this;return void 0===a&&(a={}),(new b.Queue).push(function(){return!c.hasCapacity("list")||void 0!==a.query&&!c.hasCapacity("query")||void 0!==a.sort_on&&!c.hasCapacity("sort")||void 0!==a.select_list&&!c.hasCapacity("select")||void 0!==a.include_docs&&!c.hasCapacity("include")||void 0!==a.limit&&!c.hasCapacity("limit")?void 0:c.buildQuery(a)}).push(function(a){return{data:{rows:a,total_rows:a.length}}})},t(u,"allAttachments",r),t(u,"repair"),u.prototype.repair=function(){var a=this,c=arguments;return(new b.Queue).push(function(){var b=a.__storage.repair;return void 0!==b?a.__storage.repair.apply(a.__storage,c):void 0})},v.prototype.createJIO=function(a,b){if("string"!=typeof a.type)throw new TypeError("Invalid storage description");if(!this.__storage_types[a.type])throw new TypeError("Unknown storage '"+a.type+"'");return new u(a.type,new this.__storage_types[a.type](a,b))},v.prototype.addStorage=function(a,b){if("string"!=typeof a)throw new TypeError("jIO.addStorage(): Argument 1 is not of type 'string'");if("function"!=typeof b)throw new TypeError("jIO.addStorage(): Argument 2 is not of type 'function'");if(void 0!==this.__storage_types[a])throw new TypeError("jIO.addStorage(): Storage type already exists");this.__storage_types[a]=b},v.prototype.util=x,v.prototype.QueryFactory=d,v.prototype.Query=e,w=new v,a.jIO=w}(window,RSVP,Blob,QueryFactory,Query,atob,FileReader,ArrayBuffer,Uint8Array,navigator),function(){function a(a){"use strict";var d={fill:0},f=function(a){for(a+=9;a%64>0;a+=1);return a},g=function(a,b){for(var c=b>>2;c<a.length;c++)a[c]=0},h=function(a,b,c){a[b>>2]|=128<<24-(b%4<<3),a[((b>>2)+2&-16)+14]=c>>29,a[((b>>2)+2&-16)+15]=c<<3;
},i=function(a,b,c,d,e){var f,g=this,h=e%4,i=d%4,j=d-i;if(j>0)switch(h){case 0:a[e+3|0]=g.charCodeAt(c);case 1:a[e+2|0]=g.charCodeAt(c+1);case 2:a[e+1|0]=g.charCodeAt(c+2);case 3:a[0|e]=g.charCodeAt(c+3)}for(f=h;j>f;f=f+4|0)b[e+f>>2]=g.charCodeAt(c+f)<<24|g.charCodeAt(c+f+1)<<16|g.charCodeAt(c+f+2)<<8|g.charCodeAt(c+f+3);switch(i){case 3:a[e+j+1|0]=g.charCodeAt(c+j+2);case 2:a[e+j+2|0]=g.charCodeAt(c+j+1);case 1:a[e+j+3|0]=g.charCodeAt(c+j)}},j=function(a,b,c,d,e){var f,g=this,h=e%4,i=d%4,j=d-i;if(j>0)switch(h){case 0:a[e+3|0]=g[c];case 1:a[e+2|0]=g[c+1];case 2:a[e+1|0]=g[c+2];case 3:a[0|e]=g[c+3]}for(f=4-h;j>f;f=f+=4)b[e+f>>2]=g[c+f]<<24|g[c+f+1]<<16|g[c+f+2]<<8|g[c+f+3];switch(i){case 3:a[e+j+1|0]=g[c+j+2];case 2:a[e+j+2|0]=g[c+j+1];case 1:a[e+j+3|0]=g[c+j]}},k=function(a,b,d,e,f){var g,h=this,i=f%4,j=e%4,k=e-j,l=new Uint8Array(c.readAsArrayBuffer(h.slice(d,d+e)));if(k>0)switch(i){case 0:a[f+3|0]=l[0];case 1:a[f+2|0]=l[1];case 2:a[f+1|0]=l[2];case 3:a[0|f]=l[3]}for(g=4-i;k>g;g=g+=4)b[f+g>>2]=l[g]<<24|l[g+1]<<16|l[g+2]<<8|l[g+3];switch(j){case 3:a[f+k+1|0]=l[k+2];case 2:a[f+k+2|0]=l[k+1];case 1:a[f+k+3|0]=l[k]}},l=function(a){switch(e.getDataType(a)){case"string":return i.bind(a);case"array":return j.bind(a);case"buffer":return j.bind(a);case"arraybuffer":return j.bind(new Uint8Array(a));case"view":return j.bind(new Uint8Array(a.buffer,a.byteOffset,a.byteLength));case"blob":return k.bind(a)}},m=function(a){var b,c,d="0123456789abcdef",e=[],f=new Uint8Array(a);for(b=0;b<f.length;b++)c=f[b],e[b]=d.charAt(c>>4&15)+d.charAt(c>>0&15);return e.join("")},n=function(a){var b;if(65536>=a)return 65536;if(16777216>a)for(b=1;a>b;b<<=1);else for(b=16777216;a>b;b+=16777216);return b},o=function(a){if(a%64>0)throw new Error("Chunk size must be a multiple of 128 bit");d.maxChunkLen=a,d.padMaxChunkLen=f(a),d.heap=new ArrayBuffer(n(d.padMaxChunkLen+320+20)),d.h32=new Int32Array(d.heap),d.h8=new Int8Array(d.heap),d.core=b({Int32Array:Int32Array,DataView:DataView},{},d.heap),d.buffer=null};o(a||65536);var p=function(a,b){var c=new Int32Array(a,b+320,5);c[0]=1732584193,c[1]=-271733879,c[2]=-1732584194,c[3]=271733878,c[4]=-1009589776},q=function(a,b){var c=f(a),e=new Int32Array(d.heap,0,c>>2);return g(e,a),h(e,a,b),c},r=function(a,b,c){l(a)(d.h8,d.h32,b,c,0)},s=function(a,b,c,e,f){var g=c;f&&(g=q(c,e)),r(a,b,c),d.core.hash(g,d.padMaxChunkLen)},t=function(a,b){var c=new Int32Array(a,b+320,5),d=new Int32Array(5),e=new DataView(d.buffer);return e.setInt32(0,c[0],!1),e.setInt32(4,c[1],!1),e.setInt32(8,c[2],!1),e.setInt32(12,c[3],!1),e.setInt32(16,c[4],!1),d},u=this.rawDigest=function(a){var b=a.byteLength||a.length||a.size||0;p(d.heap,d.padMaxChunkLen);var c=0,e=d.maxChunkLen;for(c=0;b>c+e;c+=e)s(a,c,e,b,!1);return s(a,c,b-c,b,!0),t(d.heap,d.padMaxChunkLen)};this.digest=this.digestFromString=this.digestFromBuffer=this.digestFromArrayBuffer=function(a){return m(u(a).buffer)}}function b(a,b,c){"use asm";function d(a,b){a|=0,b|=0;var c=0,d=0,f=0,g=0,h=0,i=0,j=0,k=0,l=0,m=0,n=0,o=0,p=0,q=0;for(f=e[b+320>>2]|0,h=e[b+324>>2]|0,j=e[b+328>>2]|0,l=e[b+332>>2]|0,n=e[b+336>>2]|0,c=0;(c|0)<(a|0);c=c+64|0){for(g=f,i=h,k=j,m=l,o=n,d=0;(d|0)<64;d=d+4|0)q=e[c+d>>2]|0,p=((f<<5|f>>>27)+(h&j|~h&l)|0)+((q+n|0)+1518500249|0)|0,n=l,l=j,j=h<<30|h>>>2,h=f,f=p,e[a+d>>2]=q;for(d=a+64|0;(d|0)<(a+80|0);d=d+4|0)q=(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])<<1|(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])>>>31,p=((f<<5|f>>>27)+(h&j|~h&l)|0)+((q+n|0)+1518500249|0)|0,n=l,l=j,j=h<<30|h>>>2,h=f,f=p,e[d>>2]=q;for(d=a+80|0;(d|0)<(a+160|0);d=d+4|0)q=(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])<<1|(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])>>>31,p=((f<<5|f>>>27)+(h^j^l)|0)+((q+n|0)+1859775393|0)|0,n=l,l=j,j=h<<30|h>>>2,h=f,f=p,e[d>>2]=q;for(d=a+160|0;(d|0)<(a+240|0);d=d+4|0)q=(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])<<1|(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])>>>31,p=((f<<5|f>>>27)+(h&j|h&l|j&l)|0)+((q+n|0)-1894007588|0)|0,n=l,l=j,j=h<<30|h>>>2,h=f,f=p,e[d>>2]=q;for(d=a+240|0;(d|0)<(a+320|0);d=d+4|0)q=(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])<<1|(e[d-12>>2]^e[d-32>>2]^e[d-56>>2]^e[d-64>>2])>>>31,p=((f<<5|f>>>27)+(h^j^l)|0)+((q+n|0)-899497514|0)|0,n=l,l=j,j=h<<30|h>>>2,h=f,f=p,e[d>>2]=q;f=f+g|0,h=h+i|0,j=j+k|0,l=l+m|0,n=n+o|0}e[b+320>>2]=f,e[b+324>>2]=h,e[b+328>>2]=j,e[b+332>>2]=l,e[b+336>>2]=n}var e=new a.Int32Array(c);return{hash:d}}if("undefined"!=typeof module?module.exports=a:"undefined"!=typeof window&&(window.Rusha=a),"undefined"!=typeof FileReaderSync){var c=new FileReaderSync,d=new a(4194304);self.onmessage=function(a){var b,c=a.data.data;try{b=d.digest(c),self.postMessage({id:a.data.id,hash:b})}catch(e){self.postMessage({id:a.data.id,error:e.name})}}}var e={getDataType:function(a){if("string"==typeof a)return"string";if(a instanceof Array)return"array";if("undefined"!=typeof global&&global.Buffer&&global.Buffer.isBuffer(a))return"buffer";if(a instanceof ArrayBuffer)return"arraybuffer";if(a.buffer instanceof ArrayBuffer)return"view";if(a instanceof Blob)return"blob";throw new Error("Unsupported data type.")}}}(),function(a,b,c,d){"use strict";function e(a){if(void 0!==a&&"string"!=typeof a)throw new TypeError("You must pass a string.");this.message=a||"Skip some asynchronous code"}function f(a){return B.digestFromString(a)}function g(a){return B.digestFromArrayBuffer(a)}function h(b){if(this._query_options=b.query||{},void 0!==b.signature_hash_key&&(this._query_options.select_list=[b.signature_hash_key]),this._signature_hash_key=b.signature_hash_key,this._local_sub_storage=a.createJIO(b.local_sub_storage),this._remote_sub_storage=a.createJIO(b.remote_sub_storage),b.hasOwnProperty("signature_sub_storage")?(this._signature_sub_storage=a.createJIO(b.signature_sub_storage),this._custom_signature_sub_storage=!0):(this._signature_hash="_replicate_"+f(d(b.local_sub_storage)+d(b.remote_sub_storage)+d(this._query_options)),this._signature_sub_storage=a.createJIO({type:"query",sub_storage:{type:"document",document_id:this._signature_hash,sub_storage:b.local_sub_storage}}),this._custom_signature_sub_storage=!1),this._use_remote_post=b.use_remote_post||!1,this._parallel_operation_attachment_amount=b.parallel_operation_attachment_amount||1,this._parallel_operation_amount=b.parallel_operation_amount||1,this._conflict_handling=b.conflict_handling||0,this._conflict_handling!==C&&this._conflict_handling!==D&&this._conflict_handling!==E&&this._conflict_handling!==F)throw new a.util.jIOError("Unsupported conflict handling: "+this._conflict_handling,400);this._check_local_modification=b.check_local_modification,void 0===this._check_local_modification&&(this._check_local_modification=!0),this._check_local_creation=b.check_local_creation,void 0===this._check_local_creation&&(this._check_local_creation=!0),this._check_local_deletion=b.check_local_deletion,void 0===this._check_local_deletion&&(this._check_local_deletion=!0),this._check_remote_modification=b.check_remote_modification,void 0===this._check_remote_modification&&(this._check_remote_modification=!0),this._check_remote_creation=b.check_remote_creation,void 0===this._check_remote_creation&&(this._check_remote_creation=!0),this._check_remote_deletion=b.check_remote_deletion,void 0===this._check_remote_deletion&&(this._check_remote_deletion=!0),this._check_local_attachment_modification=b.check_local_attachment_modification,void 0===this._check_local_attachment_modification&&(this._check_local_attachment_modification=!1),this._check_local_attachment_creation=b.check_local_attachment_creation,void 0===this._check_local_attachment_creation&&(this._check_local_attachment_creation=!1),this._check_local_attachment_deletion=b.check_local_attachment_deletion,void 0===this._check_local_attachment_deletion&&(this._check_local_attachment_deletion=!1),this._check_remote_attachment_modification=b.check_remote_attachment_modification,void 0===this._check_remote_attachment_modification&&(this._check_remote_attachment_modification=!1),this._check_remote_attachment_creation=b.check_remote_attachment_creation,void 0===this._check_remote_attachment_creation&&(this._check_remote_attachment_creation=!1),this._check_remote_attachment_deletion=b.check_remote_attachment_deletion,void 0===this._check_remote_attachment_deletion&&(this._check_remote_attachment_deletion=!1)}function i(a,c,d,e){function f(e){e.push(function(){if(d.length>0){var g=d.shift(),h=new b.Queue;return g[0]=h,c.apply(a,g),f(e),h}})}var g,h=[];for(g=0;e>g;g+=1)h.push(new b.Queue),f(h[g]);return e>1?b.all(h):h[0]}function j(a,c,d,e){return(new b.Queue).push(function(){return d.hasOwnProperty(e)?void 0:c.allDocs(a._query_options).push(function(a){var b,c={};for(b=0;b<a.data.total_rows;b+=1)c[a.data.rows[b].id]=a.data.rows[b].value;d[e]=c})}).push(function(){return d[e]})}function k(a,b,c,d,e){return c.removeAttachment(d,e).push(function(){return a._signature_sub_storage.removeAttachment(d,e)}).push(function(){b[e]=null})}function l(a,b,c,d,e,f,g){return c.putAttachment(f,g,d).push(function(){return a._signature_sub_storage.putAttachment(f,g,JSON.stringify({hash:e}))}).push(function(){b[g]=null})}function m(b,c,d,e,f,h,i,j,m,n,o,p){var q;return i.getAttachment(j,m).push(function(b){return q=b,a.util.readBlobAsArrayBuffer(q)}).push(function(a){return g(a.target.result)},function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return q=null,null;throw b}).push(function(g){if(e===g)return null===e?b._signature_sub_storage.removeAttachment(j,m).push(function(){c[m]=null}):b._signature_sub_storage.putAttachment(j,m,JSON.stringify({hash:e})).push(function(){c[m]=null});if(g===d||n===!0)return null===e?k(b,c,i,j,m):l(b,c,i,f,e,j,m);if(p!==!0){if(o===!0||null===e)return null===g?k(b,c,h,j,m):l(b,c,h,q,g,j,m);if(null===g)return l(b,c,i,f,e,j,m);throw new a.util.jIOError("Conflict on '"+j+"' with attachment '"+m+"'",409)}})}function n(c,d,e,f,h,i,j,k,l,n,o,p){var q,r;c.push(function(){if(o===!0)return b.all([f.getAttachment(i,j),{hash:null}]);if(p===!0)return b.all([f.getAttachment(i,j),d._signature_sub_storage.getAttachment(i,j,{format:"json"})]);throw new a.util.jIOError("Unexpected call of checkAttachmentSignatureDifference",409)}).push(function(b){return q=b[0],r=b[1].hash,a.util.readBlobAsArrayBuffer(q)}).push(function(a){var b=a.target.result,c=g(b);return c!==r?m(d,e,r,c,q,f,h,i,j,k,l,n):void 0})}function o(a,b,c,d,e,f,g,h,i,j){var k;a.push(function(){return b._signature_sub_storage.getAttachment(e,f,{format:"json"})}).push(function(a){return k=a.hash,m(b,c,k,null,null,g,d,e,f,h,i,j)})}function p(b,c,d,e,f,g,h){var j={},k={};return e.allAttachments(d).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return{};throw b}).push(function(a){var l,m,o,p=[];for(o in a)a.hasOwnProperty(o)&&(c.hasOwnProperty(o)||(j[o]=null));for(o in g)g.hasOwnProperty(o)&&(c.hasOwnProperty(o)||(k[o]=null));for(o in j)j.hasOwnProperty(o)&&(l=k.hasOwnProperty(o)&&h.check_modification,m=!k.hasOwnProperty(o)&&h.check_creation,(l===!0||m===!0)&&p.push([void 0,b,c,e,f,d,o,h.conflict_force,h.conflict_revert,h.conflict_ignore,m,l]));return i(b,n,p,b._parallel_operation_attachment_amount)}).push(function(){var a,g=[];if(h.check_deletion===!0){for(a in k)k.hasOwnProperty(a)&&(j.hasOwnProperty(a)||g.push([void 0,b,c,f,d,a,e,h.conflict_force,h.conflict_revert,h.conflict_ignore]));return i(b,o,g,b._parallel_operation_attachment_amount)}})}function q(a,b,c,d){return a.push(function(){return d.removeAttachment(b,c)})}function r(b,c,d,e,f,g,h){return b.push(function(){return g.getAttachment(c,d,{format:"json"}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return{hash:null};throw b}).push(function(a){return a.hash!==h?e.getAttachment(c,d).push(function(a){return f.putAttachment(c,d,a)}).push(function(){return g.putAttachment(c,d,JSON.stringify({hash:h}))}):void 0})})}function s(a,c,d,e,f){return d!==e?(new b.Queue).push(function(){return b.all([a._signature_sub_storage.allAttachments(c),a._local_sub_storage.allAttachments(c),a._remote_sub_storage.allAttachments(c)])}).push(function(e){var g,h,j,k,l,m=[],n=[],o=e[0],p=e[1],s=e[2],t=a._check_local_attachment_modification,u=a._check_local_attachment_creation,v=a._check_local_attachment_deletion,w=a._check_remote_attachment_modification,x=a._check_remote_attachment_creation,y=a._check_remote_attachment_deletion;f?(h=p,j=s,k=a._local_sub_storage,l=a._remote_sub_storage):(h=s,j=p,k=a._remote_sub_storage,l=a._local_sub_storage,t=w,u=x,v=y,x=u,y=v);for(g in h)h.hasOwnProperty(g)&&(u&&!o.hasOwnProperty(g)||t&&o.hasOwnProperty(g))&&m.push([void 0,c,g,k,l,a._signature_sub_storage,d]);for(g in o)o.hasOwnProperty(g)&&v&&!h.hasOwnProperty(g)&&n.push([void 0,c,g,a._signature_sub_storage]);for(g in j)j.hasOwnProperty(g)&&(h.hasOwnProperty(g)||(v&&o.hasOwnProperty(g)||x&&!o.hasOwnProperty(g))&&n.push([void 0,c,g,l]));return b.all([i(a,r,m,a._parallel_operation_attachment_amount),i(a,q,n,a._parallel_operation_attachment_amount)])}).push(function(){return a._signature_sub_storage.put(c,{hash:d,attachment_hash:d,from_local:f})}):void 0}function t(c,d,e,f,g,h){if(void 0!==e)return s(c,d,f,g,h);var i={};return(new b.Queue).push(function(){return c._check_local_attachment_modification||c._check_local_attachment_creation||c._check_local_attachment_deletion||c._check_remote_attachment_modification||c._check_remote_attachment_creation||c._check_remote_attachment_deletion?c._signature_sub_storage.allAttachments(d):{}}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return{};throw b}).push(function(a){return c._check_local_attachment_modification||c._check_local_attachment_creation||c._check_local_attachment_deletion?p(c,i,d,c._local_sub_storage,c._remote_sub_storage,a,{conflict_force:c._conflict_handling===D,conflict_revert:c._conflict_handling===E,conflict_ignore:c._conflict_handling===F,check_modification:c._check_local_attachment_modification,check_creation:c._check_local_attachment_creation,check_deletion:c._check_local_attachment_deletion}).push(function(){return a}):a}).push(function(a){return c._check_remote_attachment_modification||c._check_remote_attachment_creation||c._check_remote_attachment_deletion?p(c,i,d,c._remote_sub_storage,c._local_sub_storage,a,{use_revert_post:c._use_remote_post,conflict_force:c._conflict_handling===E,conflict_revert:c._conflict_handling===D,conflict_ignore:c._conflict_handling===F,check_modification:c._check_remote_attachment_modification,check_creation:c._check_remote_attachment_creation,check_deletion:c._check_remote_attachment_deletion}):void 0})}function u(c,d,f,g,h,i,j,k,l){var m,n,o=new b.Queue,p=!0;return void 0===l&&(l={}),n=l.from_local,null===g&&o.push(function(){return d.get(i)}).push(function(a){g=a},function(b){if(b instanceof a.util.jIOError&&404===b.status_code)throw new e(i);throw b}),l.use_post?o.push(function(){return f.post(g)}).push(function(a){return p=!1,m=a,d.put(m,g)}).push(function(){return d.allAttachments(i)}).push(function(a){function c(a){f.push(function(){return d.getAttachment(i,a)}).push(function(b){return d.putAttachment(m,a,b)})}var e,f=new b.Queue;for(e in a)a.hasOwnProperty(e)&&c(e);return f}).push(function(){return d.remove(i)}).push(function(){return c._signature_sub_storage.remove(i)}).push(function(){return p=!0,c._signature_sub_storage.put(m,{hash:h,from_local:n})}).push(function(){j[m]=null}):o.push(function(){return l.create_new_document===!0?(delete k[i],c._signature_sub_storage.remove(i)):void 0}).push(function(){return f.put(i,g)}).push(function(){return c._signature_sub_storage.put(i,{hash:h,from_local:n})}),o.push(function(){p&&(j[i]=null)}).push(void 0,function(a){if(!(a instanceof e))throw a})}function v(b,c,d,e,f){var g;return g=void 0!==b._signature_hash_key?c.remove(d).push(function(){return b._signature_sub_storage.remove(d)}):t(b,d).push(function(){return c.allAttachments(d)}).push(function(a){return"{}"===JSON.stringify(a)?c.remove(d).push(function(){return b._signature_sub_storage.remove(d)}):void 0},function(b){if(!(b instanceof a.util.jIOError&&404===b.status_code))throw b}),g.push(function(){e[d]=null,f[d]=null})}function w(c,e,g,h,i,k,l,m,n,o,p,q,r,s,t){var w=t.from_local;return(new b.Queue).push(function(){return void 0!==t.signature_hash_key?j(c,o,h,i).push(function(a){return a.hasOwnProperty(p)?[null,a[p][t.signature_hash_key]]:[null,null]}):o.get(p).push(function(a){return[a,f(d(a))]},function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return[null,null];throw b})}).push(function(b){var f=b[0],h=b[1];if(l===h)return null===l?c._signature_sub_storage.remove(p).push(function(){e[p]=null}):c._signature_sub_storage.put(p,{hash:l,from_local:w}).push(function(){e[p]=null});if(h===k||q===!0)return null===l?v(c,o,p,e,g):u(c,n,o,m,l,p,e,g,{use_post:t.use_post&&null===h,from_local:w,create_new_document:null===h&&null!==k});if(s!==!0){if(r===!0||null===l)return null===h?v(c,n,p,e,g):u(c,o,n,f,h,p,e,g,{use_post:t.use_revert_post&&null===l,from_local:!w,create_new_document:null===l&&null!==k});if(null===h)return u(c,n,o,m,l,p,e,g,{use_post:t.use_post,from_local:w,create_new_document:null!==k});throw m=m||l,f=f||h,new a.util.jIOError("Conflict on '"+p+"': "+d(m)+" !== "+d(f),409)}})}function x(a,b,c,d,e,f,g,h,i,j,k,l,m){var n;a.push(function(){return b._signature_sub_storage.get(h)}).push(function(a){return n=a.hash,w(b,c,d,e,f,n,null,null,i,g,h,j,k,l,m)})}function y(a,b,c,e,g,h,i,j,k,l,m,n,o,p,q){a.push(function(){return null===o?i.get(k):null}).push(function(a){return null===o&&(o=f(d(a))),o!==p?w(b,c,e,g,h,p,o,a,i,j,k,l,m,n,q):void 0})}function z(a,c,d,e,f,g,h,k,l,m){var n=[],o=[];return m.hasOwnProperty("use_post")||(m.use_post=!1),m.hasOwnProperty("use_revert_post")||(m.use_revert_post=!1),j(a,h,e,f).push(function(f){var j,p,q,r,s,t,u={},v={},w=new b.Queue;for(t in f)f.hasOwnProperty(t)&&(c.hasOwnProperty(t)||(u[t]=f[t]));for(j=0;j<l.data.total_rows;j+=1)c.hasOwnProperty(l.data.rows[j].id)||(v[l.data.rows[j].id]=l.data.rows[j].value.hash);for(t in u)u.hasOwnProperty(t)&&(p=v.hasOwnProperty(t)&&m.check_modification,q=!v.hasOwnProperty(t)&&m.check_creation,q===!0?r=null:p===!0&&(r=v[t]),s=null,void 0!==m.signature_hash_key&&(s=u[t][m.signature_hash_key],p===!0&&(p=!1,s!==r&&(p=!0))),(p===!0||q===!0)&&n.push([void 0,a,c,d,e,g,h,k,t,m.conflict_force,m.conflict_revert,m.conflict_ignore,s,r,m]));w.push(function(){return i(a,y,n,m.operation_amount)});for(t in v)v.hasOwnProperty(t)&&(u.hasOwnProperty(t)||(m.check_deletion===!0?o.push([void 0,a,c,d,e,g,k,t,h,m.conflict_force,m.conflict_revert,m.conflict_ignore,m]):d[t]=null));return 0!==o.length&&w.push(function(){return i(a,x,o,m.operation_amount)}),w})}function A(a,b,c,d,e,f,g){a.push(function(){return t(b,c,d,e,f,g)})}var B=new c,C=0,D=1,E=2,F=3;e.prototype=new Error,e.prototype.constructor=e,h.prototype.remove=function(b){if(b===this._signature_hash)throw new a.util.jIOError(this._signature_hash+" is frozen",403);return this._local_sub_storage.remove.apply(this._local_sub_storage,arguments)},h.prototype.post=function(){return this._local_sub_storage.post.apply(this._local_sub_storage,arguments)},h.prototype.put=function(b){if(b===this._signature_hash)throw new a.util.jIOError(this._signature_hash+" is frozen",403);return this._local_sub_storage.put.apply(this._local_sub_storage,arguments)},h.prototype.get=function(){return this._local_sub_storage.get.apply(this._local_sub_storage,arguments)},h.prototype.getAttachment=function(){return this._local_sub_storage.getAttachment.apply(this._local_sub_storage,arguments)},h.prototype.allAttachments=function(){return this._local_sub_storage.allAttachments.apply(this._local_sub_storage,arguments)},h.prototype.putAttachment=function(b){if(b===this._signature_hash)throw new a.util.jIOError(this._signature_hash+" is frozen",403);return this._local_sub_storage.putAttachment.apply(this._local_sub_storage,arguments)},h.prototype.removeAttachment=function(b){if(b===this._signature_hash)throw new a.util.jIOError(this._signature_hash+" is frozen",403);return this._local_sub_storage.removeAttachment.apply(this._local_sub_storage,arguments)},h.prototype.hasCapacity=function(){return this._local_sub_storage.hasCapacity.apply(this._local_sub_storage,arguments)},h.prototype.buildQuery=function(){return this._local_sub_storage.buildQuery.apply(this._local_sub_storage,arguments)},h.prototype.repair=function(){var c=this,d=arguments,e={},f={},g={};return(new b.Queue).push(function(){return c._custom_signature_sub_storage===!1?(e[c._signature_hash]=null,c._signature_sub_storage.__storage._sub_storage.__storage._sub_storage.get(c._signature_hash)):void 0}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return c._signature_sub_storage.__storage._sub_storage.__storage._sub_storage.put(c._signature_hash,{});throw b}).push(function(){return b.all([c._local_sub_storage.repair.apply(c._local_sub_storage,d),c._remote_sub_storage.repair.apply(c._remote_sub_storage,d)])}).push(function(){return c._check_local_modification||c._check_local_creation||c._check_local_deletion||c._check_remote_modification||c._check_remote_creation||c._check_remote_deletion?c._signature_sub_storage.allDocs({select_list:["hash"]}):void 0}).push(function(a){return c._check_local_modification||c._check_local_creation||c._check_local_deletion?z(c,e,f,g,"local","remote",c._local_sub_storage,c._remote_sub_storage,a,{use_post:c._use_remote_post,conflict_force:c._conflict_handling===D,conflict_revert:c._conflict_handling===E,conflict_ignore:c._conflict_handling===F,check_modification:c._check_local_modification,check_creation:c._check_local_creation,check_deletion:c._check_local_deletion,operation_amount:c._parallel_operation_amount,signature_hash_key:c._signature_hash_key,from_local:!0}).push(function(){return a}):a}).push(function(a){return c._check_remote_modification||c._check_remote_creation||c._check_remote_deletion?z(c,e,f,g,"remote","local",c._remote_sub_storage,c._local_sub_storage,a,{use_revert_post:c._use_remote_post,conflict_force:c._conflict_handling===E,conflict_revert:c._conflict_handling===D,conflict_ignore:c._conflict_handling===F,check_modification:c._check_remote_modification,check_creation:c._check_remote_creation,check_deletion:c._check_remote_deletion,operation_amount:c._parallel_operation_amount,signature_hash_key:c._signature_hash_key,from_local:!1}):void 0}).push(function(){return c._check_local_attachment_modification||c._check_local_attachment_creation||c._check_local_attachment_deletion||c._check_remote_attachment_modification||c._check_remote_attachment_creation||c._check_remote_attachment_deletion?c._signature_sub_storage.allDocs({select_list:["hash","attachment_hash","from_local"]}).push(function(a){var b,d,e=[],g=a.data.total_rows;for(b=0;g>b;b+=1)d=a.data.rows[b],f.hasOwnProperty(d.id)||e.push([void 0,c,d.id,c._signature_hash_key,d.value.hash,d.value.attachment_hash,d.value.from_local]);return i(c,A,e,c._parallel_operation_amount)}):void 0})},a.addStorage("replicate",h)}(jIO,RSVP,Rusha,jIO.util.stringify),function(a){"use strict";function b(a){this._sub_storage=jIO.createJIO(a.sub_storage)}var c=new a;b.prototype.post=function(a){return this._sub_storage.put(c.digestFromString(JSON.stringify(a)),a)},b.prototype.get=function(){return this._sub_storage.get.apply(this._sub_storage,arguments)},b.prototype.remove=function(){return this._sub_storage.remove.apply(this._sub_storage,arguments)},b.prototype.hasCapacity=function(){return this._sub_storage.hasCapacity.apply(this._sub_storage,arguments)},b.prototype.buildQuery=function(){return this._sub_storage.buildQuery.apply(this._sub_storage,arguments)},b.prototype.getAttachment=function(){return this._sub_storage.getAttachment.apply(this._sub_storage,arguments)},b.prototype.putAttachment=function(){return this._sub_storage.putAttachment.apply(this._sub_storage,arguments)},b.prototype.removeAttachment=function(){return this._sub_storage.removeAttachment.apply(this._sub_storage,arguments)},b.prototype.allAttachments=function(){return this._sub_storage.allAttachments.apply(this._sub_storage,arguments)},b.prototype.repair=function(){return this._sub_storage.repair.apply(this._sub_storage,arguments)},jIO.addStorage("sha",b)}(Rusha),function(a){"use strict";function b(b){this._sub_storage=a.createJIO(b.sub_storage)}b.prototype.get=function(){return this._sub_storage.get.apply(this._sub_storage,arguments)},b.prototype.allAttachments=function(){return this._sub_storage.allAttachments.apply(this._sub_storage,arguments)},b.prototype.post=function(a){function b(){return("0000"+Math.floor(65536*Math.random()).toString(16)).slice(-4)}var c=b()+b()+"-"+b()+"-"+b()+"-"+b()+"-"+b()+b()+b();return this.put(c,a)},b.prototype.put=function(){return this._sub_storage.put.apply(this._sub_storage,arguments)},b.prototype.remove=function(){return this._sub_storage.remove.apply(this._sub_storage,arguments)},b.prototype.getAttachment=function(){return this._sub_storage.getAttachment.apply(this._sub_storage,arguments)},b.prototype.putAttachment=function(){return this._sub_storage.putAttachment.apply(this._sub_storage,arguments)},b.prototype.removeAttachment=function(){return this._sub_storage.removeAttachment.apply(this._sub_storage,arguments)},b.prototype.repair=function(){return this._sub_storage.repair.apply(this._sub_storage,arguments)},b.prototype.hasCapacity=function(a){return this._sub_storage.hasCapacity(a)},b.prototype.buildQuery=function(){return this._sub_storage.buildQuery.apply(this._sub_storage,arguments)},a.addStorage("uuid",b)}(jIO),function(a,b,c){"use strict";function d(){this._database={}}d.prototype.put=function(a,c){return this._database.hasOwnProperty(a)||(this._database[a]={attachments:{}}),this._database[a].doc=b.stringify(c),a},d.prototype.get=function(c){try{return b.parse(this._database[c].doc)}catch(d){if(d instanceof TypeError)throw new a.util.jIOError("Cannot find document: "+c,404);throw d}},d.prototype.allAttachments=function(b){var c,d={};try{for(c in this._database[b].attachments)this._database[b].attachments.hasOwnProperty(c)&&(d[c]={})}catch(e){if(e instanceof TypeError)throw new a.util.jIOError("Cannot find document: "+b,404);throw e}return d},d.prototype.remove=function(a){return delete this._database[a],a},d.prototype.getAttachment=function(b,c){try{var d=this._database[b].attachments[c];if(void 0===d)throw new a.util.jIOError("Cannot find attachment: "+b+" , "+c,404);return a.util.dataURItoBlob(d)}catch(e){if(e instanceof TypeError)throw new a.util.jIOError("Cannot find attachment: "+b+" , "+c,404);throw e}},d.prototype.putAttachment=function(b,d,e){var f;try{f=this._database[b].attachments}catch(g){if(g instanceof TypeError)throw new a.util.jIOError("Cannot find document: "+b,404);throw g}return(new c.Queue).push(function(){return a.util.readBlobAsDataURL(e)}).push(function(a){f[d]=a.target.result})},d.prototype.removeAttachment=function(b,c){try{delete this._database[b].attachments[c]}catch(d){if(d instanceof TypeError)throw new a.util.jIOError("Cannot find document: "+b,404);throw d}},d.prototype.hasCapacity=function(a){return"list"===a||"include"===a},d.prototype.buildQuery=function(a){var c,d=[];for(c in this._database)this._database.hasOwnProperty(c)&&(a.include_docs===!0?d.push({id:c,value:{},doc:b.parse(this._database[c].doc)}):d.push({id:c,value:{}}));return d},a.addStorage("memory",d)}(jIO,JSON,RSVP),function(a,b,c,d){"use strict";function e(a){this._sub_storage=jIO.createJIO(a.sub_storage)}function f(a,b){return a.indexOf(b)===a.length-b.length}var g="application/x-jio-utf16_lz_string";e.prototype.get=function(){return this._sub_storage.get.apply(this._sub_storage,arguments)},e.prototype.post=function(){return this._sub_storage.post.apply(this._sub_storage,arguments)},e.prototype.put=function(){return this._sub_storage.put.apply(this._sub_storage,arguments)},e.prototype.remove=function(){return this._sub_storage.remove.apply(this._sub_storage,arguments)},e.prototype.hasCapacity=function(){return this._sub_storage.hasCapacity.apply(this._sub_storage,arguments)},e.prototype.buildQuery=function(){return this._sub_storage.buildQuery.apply(this._sub_storage,arguments)},e.prototype.getAttachment=function(b,e){var f=this;return f._sub_storage.getAttachment(b,e).push(function(b){return b.type!==g?b:(new a.Queue).push(function(){return jIO.util.readBlobAsText(b,"utf16")}).push(function(a){var e=c.decompressFromUTF16(a.target.result);if(""===e)return b;try{return jIO.util.dataURItoBlob(e)}catch(f){if(f instanceof d)return b;throw f}})})},e.prototype.putAttachment=function(d,e,h){var i=this;return 0===h.type.indexOf("text/")||f(h.type,"xml")||f(h.type,"json")?(new a.Queue).push(function(){return jIO.util.readBlobAsDataURL(h)}).push(function(a){var f=c.compressToUTF16(a.target.result);return h=new b([f],{type:g}),i._sub_storage.putAttachment(d,e,h)}):this._sub_storage.putAttachment.apply(this._sub_storage,arguments)},e.prototype.removeAttachment=function(){return this._sub_storage.removeAttachment.apply(this._sub_storage,arguments)},e.prototype.allAttachments=function(){return this._sub_storage.allAttachments.apply(this._sub_storage,arguments)},jIO.addStorage("zip",e)}(RSVP,Blob,LZString,DOMException),function(a,b,c){"use strict";function d(a){this._dom_parser=(new b).parseFromString(a,"text/xml")}function e(a){this._dom_parser=(new b).parseFromString(a,"text/xml")}function f(a){return a._sub_storage.getAttachment(a._document_id,a._attachment_id,{format:"text"}).push(function(b){return new h[a._parser_name](b)})}function g(b){this._attachment_id=b.attachment_id,this._document_id=b.document_id,this._parser_name=b.parser,this._sub_storage=a.createJIO(b.sub_storage)}d.prototype.parseHead=function(){var a,b,d=this._dom_parser.querySelector("opml > head"),e={};for(b=d.childNodes.length-1;b>=0;b-=1)a=d.childNodes[b],a.nodeType===c.ELEMENT_NODE&&(e[a.tagName]=a.textContent);return e},d.prototype.parseOutline=function(a,b,c,d,e){var f,g,h,i={};if((e===c||void 0===e)&&(a.push({id:c,value:{}}),d)){for(g=b.attributes.length-1;g>=0;g-=1)f=b.attributes[g],f.value&&(i[f.name]=f.value);a[a.length-1].doc=i}for(g=b.childNodes.length-1;g>=0;g-=1)h=b.childNodes[g],"outline"===h.tagName&&this.parseOutline(a,h,c+"/"+g,d,e)},d.prototype.getDocumentList=function(a,b){var c,d,e=this._dom_parser.querySelectorAll("body > outline");for("/0"===b||void 0===b?(c=[{id:"/0",value:{}}],a&&(c[0].doc=this.parseHead())):c=[],d=0;d<e.length;d+=1)this.parseOutline(c,e[d],"/1/"+d,a,b);return c},e.prototype.parseElement=function(a){var b,d,e,f,g={};for(d=a.childNodes.length-1;d>=0;d-=1)if(b=a.childNodes[d],b.nodeType===c.ELEMENT_NODE&&"item"!==b.tagName)for(g[b.tagName]=b.textContent,e=b.attributes.length-1;e>=0;e-=1)f=b.attributes[e],f.value&&(g[b.tagName+"_"+f.name]=f.value);return g},e.prototype.getDocumentList=function(a,b){var c,d,e=this._dom_parser.querySelectorAll("rss > channel > item");for("/0"===b||void 0===b?(c=[{id:"/0",value:{}}],a&&(c[0].doc=this.parseElement(this._dom_parser.querySelector("rss > channel")))):c=[],d=0;d<e.length;d+=1)(b==="/0/"+d||void 0===b)&&(c.push({id:"/0/"+d,value:{}}),a&&(c[c.length-1].doc=this.parseElement(e[d])));return c};var h={rss:e,opml:d};g.prototype.hasCapacity=function(a){return"list"===a||"include"===a},g.prototype.buildQuery=function(a){return void 0===a&&(a={}),f(this).push(function(b){return b.getDocumentList(a.include_docs||!1)})},g.prototype.get=function(b){return f(this).push(function(c){var d=c.getDocumentList(!0,b);if(d.length)return d[0].doc;throw new a.util.jIOError("Cannot find parsed document: "+b,404)})},a.addStorage("parser",g)}(jIO,DOMParser,Node),function(a,b,c){"use strict";function d(a){a.hasOwnProperty("catch_error")?this._catch_error=a.catch_error:this._catch_error=!1,this._timeout=a.timeout||0}d.prototype.get=function(c){var d=this;return(new b.Queue).push(function(){return a.util.ajax({type:"HEAD",url:c,timeout:d._timeout})}).push(void 0,function(b){if(d._catch_error)return b;if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find url "+c,404);
throw b}).push(function(a){var b,c,d,e=["Content-Disposition","Content-Type","Date","Last-Modified","Vary","Cache-Control","Etag","Accept-Ranges","Content-Range"],f={};for(f.Status=a.target.status,b=0;b<e.length;b+=1)c=e[b],d=a.target.getResponseHeader(c),null!==d&&(f[c]=d);return f})},d.prototype.allAttachments=function(){return{enclosure:{}}},d.prototype.getAttachment=function(d,e){var f=this;if("enclosure"!==e)throw new a.util.jIOError("Forbidden attachment: "+d+" , "+e,400);return(new b.Queue).push(function(){return a.util.ajax({type:"GET",url:d,dataType:"blob",timeout:f._timeout})}).push(void 0,function(b){if(f._catch_error)return b;if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find url "+d,404);throw b}).push(function(a){return new c([a.target.response||a.target.responseText],{type:a.target.getResponseHeader("Content-Type")||"application/octet-stream"})})},a.addStorage("http",d)}(jIO,RSVP,Blob),function(a,b,c,d){"use strict";function e(b){if(0!==b.indexOf("/"))throw new a.util.jIOError("id "+b+" is forbidden (no begin /)",400);if(b.lastIndexOf("/")!==b.length-1)throw new a.util.jIOError("id "+b+" is forbidden (no end /)",400);return b.slice(0,-1)}function f(b){if(-1!==b.indexOf("/"))throw new a.util.jIOError("attachment "+b+" is forbidden",400)}function g(c,e,f,h){var i,j;return void 0===h?(i={path:f,recursive:!1,include_media_info:!1,include_deleted:!1,include_has_explicit_shared_members:!1,include_mounted_folders:!0},j=n):(i={cursor:h},j=o),(new b.Queue).push(function(){return a.util.ajax({type:"POST",url:j,headers:{Authorization:"Bearer "+e,"Content-Type":"application/json"},data:d.stringify(i)})}).push(function(a){var b,h=d.parse(a.target.response||a.target.responseText);for(b=0;b<h.entries.length;b+=1)"file"===h.entries[b][".tag"]&&(c[h.entries[b].name]={});return h.has_more?g(c,e,f,h.cursor):c},function(b){if(void 0!==b.target&&409===b.target.status){var c=d.parse(b.target.response||b.target.responseText);if("path"===c.error[".tag"]&&"not_folder"===c.error.path[".tag"])throw new a.util.jIOError("Not a directory: "+f+"/",404);if("path"===c.error[".tag"]&&"not_found"===c.error.path[".tag"])throw new a.util.jIOError("Cannot find document: "+f+"/",404)}throw b})}function h(a){if("string"!=typeof a.access_token||!a.access_token)throw new TypeError("Access Token' must be a string which contains more than one character.");this._access_token=a.access_token}var i="https://content.dropboxapi.com/2/files/download",j="https://content.dropboxapi.com/2/files/upload",k="https://api.dropboxapi.com/2/files/delete_v2",l="https://api.dropboxapi.com/2/files/create_folder_v2",m="https://api.dropboxapi.com/2/files/get_metadata",n="https://api.dropboxapi.com/2/files/list_folder",o="https://api.dropboxapi.com/2/files/list_folder/continue";h.prototype.put=function(c,f){var g=this;if(c=e(c),Object.getOwnPropertyNames(f).length>0)throw new a.util.jIOError("Can not store properties: "+Object.getOwnPropertyNames(f),400);return(new b.Queue).push(function(){return a.util.ajax({type:"POST",url:l,headers:{Authorization:"Bearer "+g._access_token,"Content-Type":"application/json"},data:d.stringify({path:c,autorename:!1})})}).push(void 0,function(a){if(void 0!==a.target&&409===a.target.status){var b=d.parse(a.target.response||a.target.responseText);if("path"===b.error[".tag"]&&"conflict"===b.error.path[".tag"])return}throw a})},h.prototype.remove=function(b){return b=e(b),a.util.ajax({type:"POST",url:k,headers:{Authorization:"Bearer "+this._access_token,"Content-Type":"application/json"},data:d.stringify({path:b})})},h.prototype.get=function(c){var f=this;return"/"===c?{}:(c=e(c),(new b.Queue).push(function(){return a.util.ajax({type:"POST",url:m,headers:{Authorization:"Bearer "+f._access_token,"Content-Type":"application/json"},data:d.stringify({path:c})})}).push(function(b){var e=d.parse(b.target.response||b.target.responseText);if("folder"===e[".tag"])return{};throw new a.util.jIOError("Not a directory: "+c+"/",404)},function(b){if(void 0!==b.target&&409===b.target.status){var e=d.parse(b.target.response||b.target.responseText);if("path"===e.error[".tag"]&&"not_found"===e.error.path[".tag"])throw new a.util.jIOError("Cannot find document: "+c+"/",404)}throw b}))},h.prototype.allAttachments=function(a){return a=e(a),g({},this._access_token,a)},h.prototype.putAttachment=function(b,c,g){return b=e(b),f(c),a.util.ajax({type:"POST",url:j,headers:{Authorization:"Bearer "+this._access_token,"Content-Type":"application/octet-stream","Dropbox-API-Arg":d.stringify({path:b+"/"+c,mode:"overwrite",autorename:!1,mute:!1})},data:g})},h.prototype.getAttachment=function(g,h){var j=this;return g=e(g),f(h),(new b.Queue).push(function(){return a.util.ajax({url:i,type:"POST",dataType:"blob",headers:{Authorization:"Bearer "+j._access_token,"Dropbox-API-Arg":d.stringify({path:g+"/"+h})}})}).push(function(a){return a.target.response instanceof c?a.target.response:new c([a.target.responseText],{type:a.target.getResponseHeader("Content-Type")||"application/octet-stream"})},function(e){if(void 0!==e.target&&409===e.target.status){if(!(e.target.response instanceof c)){var f=d.parse(e.target.responseText);if("path"===f.error[".tag"]&&"not_found"===f.error.path[".tag"])throw new a.util.jIOError("Cannot find attachment: "+g+"/, "+h,404);throw e}return(new b.Queue).push(function(){return a.util.readBlobAsText(e.target.response)}).push(function(b){var c=d.parse(b.target.result);if("path"===c.error[".tag"]&&"not_found"===c.error.path[".tag"])throw new a.util.jIOError("Cannot find attachment: "+g+"/, "+h,404);throw e})}throw e})},h.prototype.removeAttachment=function(c,g){var h=this;return c=e(c),f(g),(new b.Queue).push(function(){return a.util.ajax({type:"POST",url:k,headers:{Authorization:"Bearer "+h._access_token,"Content-Type":"application/json"},data:d.stringify({path:c+"/"+g})})}).push(void 0,function(b){if(void 0!==b.target&&409===b.target.status){var e=d.parse(b.target.response||b.target.responseText);if("path_lookup"===e.error[".tag"]&&"not_found"===e.error.path_lookup[".tag"])throw new a.util.jIOError("Cannot find attachment: "+c+"/, "+g,404)}throw b})},a.addStorage("dropbox",h)}(jIO,RSVP,Blob,JSON),function(a,b,c,d){"use strict";function e(c,d){return void 0===d&&(d={}),void 0!==c._authorization&&(void 0===d.headers&&(d.headers={}),d.headers.Authorization=c._authorization),void 0!==c._with_credentials&&(void 0===d.xhrFields&&(d.xhrFields={}),d.xhrFields.withCredentials=c._with_credentials),(new b.Queue).push(function(){return a.util.ajax(d)})}function f(b){if(0!==b.indexOf("/"))throw new a.util.jIOError("id "+b+" is forbidden (no begin /)",400);if(b.lastIndexOf("/")!==b.length-1)throw new a.util.jIOError("id "+b+" is forbidden (no end /)",400);return b}function g(b){if(-1!==b.indexOf("/"))throw new a.util.jIOError("attachment "+b+" is forbidden",400)}function h(a){if("string"!=typeof a.url)throw new TypeError("DavStorage 'url' is not of type string");this._url=a.url,"string"==typeof a.basic_login&&(this._authorization="Basic "+a.basic_login),this._with_credentials=a.with_credentials}h.prototype.put=function(c,d){var g=this;if(c=f(c),Object.getOwnPropertyNames(d).length>0)throw new a.util.jIOError("Can not store properties: "+Object.getOwnPropertyNames(d),400);return(new b.Queue).push(function(){return e(g,{type:"MKCOL",url:g._url+c})}).push(void 0,function(a){if(void 0===a.target||405!==a.target.status)throw a})},h.prototype.remove=function(a){return a=f(a),e(this,{type:"DELETE",url:this._url+a})},h.prototype.get=function(c){var d=this;return c=f(c),(new b.Queue).push(function(){return e(d,{type:"PROPFIND",url:d._url+c,dataType:"text",headers:{Depth:"1"}})}).push(function(){return{}},function(b){if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find document",404);throw b})},h.prototype.allAttachments=function(d){var g=this;return d=f(d),(new b.Queue).push(function(){return e(g,{type:"PROPFIND",url:g._url+d,dataType:"text",headers:{Depth:"1"}})}).push(function(a){var b,d,e={},f=(new c).parseFromString(a.target.responseText,"text/xml").querySelectorAll("D\\:response, response");for(b=1;b<f.length;b+=1)d=f[b].querySelector("D\\:href, href").textContent.split("/").slice(-1)[0],void 0!==d&&""!==d&&(e[d]={});return e},function(b){if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find document",404);throw b})},h.prototype.putAttachment=function(c,d,h){var i=this;return c=f(c),g(d),(new b.Queue).push(function(){return e(i,{type:"PUT",url:i._url+c+d,data:h})}).push(void 0,function(b){if(403===b.target.status||424===b.target.status)throw new a.util.jIOError("Cannot access subdocument",404);throw b})},h.prototype.getAttachment=function(c,h){var i=this;return c=f(c),g(h),(new b.Queue).push(function(){return e(i,{type:"GET",url:i._url+c+h,dataType:"blob"})}).push(function(a){return new d([a.target.response||a.target.responseText],{type:a.target.getResponseHeader("Content-Type")||"application/octet-stream"})},function(b){if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find attachment: "+c+" , "+h,404);throw b})},h.prototype.removeAttachment=function(c,d){var h=this;return c=f(c),g(d),(new b.Queue).push(function(){return e(h,{type:"DELETE",url:h._url+c+d})}).push(void 0,function(b){if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find attachment: "+c+" , "+d,404);throw b})},a.addStorage("dav",h)}(jIO,RSVP,DOMParser,Blob),function(a,b,c,d,e){"use strict";function f(b,c){if(404===b.target.status)throw new a.util.jIOError("Cannot find document: "+c,404);throw b}function g(b,d){var g,h;return(new c.Queue).push(function(){return a.util.ajax({type:"GET",url:s.expand({pageToken:b.nextPageToken||"",access_token:d})})}).push(function(a){for(h=e.parse(a.target.response||a.target.responseText),g=0;g<h.items.length;g+=1)h.items[g].value={},b.push(h.items[g]);return b.nextPageToken=h.nextPageToken,b},f)}function h(b){if("enclosure"!==b)throw new a.util.jIOError("Only support 'enclosure' attachment",400)}function i(a){if(void 0===a||void 0===a.access_token||"string"!=typeof a.access_token)throw new TypeError("Access Token must be a string which contains more than one character.");if(void 0!==a.trashing&&a.trashing!==!0&&a.trashing!==!1)throw new TypeError("trashing parameter must be a boolean (true or false)");this._trashing=a.trashing||!0,this._access_token=a.access_token}function j(a,b){return(new c.Queue).push(function(){return g(a,b)}).push(function(){return a.nextPageToken?j(a,b):a})}function k(b,d,g){var h="-------314159265358979323846";return(new c.Queue).push(function(){return a.util.ajax({type:b?"PUT":"POST",url:o.expand({access_token:g,id:b||[],upload:b?[]:"upload",uploadType:"multipart"}),headers:{"Content-Type":'multipart/related; boundary="'+h+'"'},data:"--"+h+"\nContent-Type: application/json; charset=UTF-8\n\n"+e.stringify(d)+"\n\n--"+h+"--"})}).push(function(a){var b=e.parse(a.target.responseText);return b.id},function(a){f(a,b)})}function l(b,d,g){return(new c.Queue).push(function(){return a.util.ajax({type:"PUT",url:o.expand({access_token:g,upload:"upload",id:b,uploadType:"media"}),data:d})}).push(function(b){if(b=e.parse(b.target.responseText),"application/vnd.google-apps.folder"===b.mimeType)throw new a.util.jIOError("cannot put attachments to folder",400);return b},function(a){f(a,b)})}function m(d,g,h){return(new c.Queue).push(function(){return a.util.ajax({type:"GET",dataType:g?"blob":"json",url:u.expand({id:d,alt:g?"media":[],access_token:h}),headers:{Authorization:"Bearer "+h}})}).push(function(a){return a.target.response||(g?new b([a.target.responseText],{type:a.target.responseHeaders["Content-Type"]}):e.parse(a.target.responseText))},function(a){f(a,d)})}var n="https://www.googleapis.com{/upload}/drive/v2/files{/id}{?uploadType,access_token}",o=d.parse(n),p="https://www.googleapis.com/drive/v2/files{/id,trash}{?access_token}",q=d.parse(p),r="https://www.googleapis.com/drive/v2/files?prettyPrint=false{&pageToken}&q=trashed=false&fields=nextPageToken,items(id){&access_token}",s=d.parse(r),t="https://www.googleapis.com/drive/v2/files{/id}{?alt}",u=d.parse(t);i.prototype.hasCapacity=function(a){return"list"===a},i.prototype.buildQuery=function(){return j([],this._access_token)},i.prototype.put=function(a,b){return k(a,b,this._access_token)},i.prototype.post=function(a){return k(void 0,a,this._access_token)},i.prototype.putAttachment=function(a,b,c){return h(b),l(a,c,this._access_token)},i.prototype.remove=function(b){var d=this;return(new c.Queue).push(function(){return a.util.ajax({type:d._trashing?"POST":"DELETE",url:q.expand({id:b,access_token:d._access_token,trash:d._trashing?"trash":[]})})}).push(void 0,function(a){f(a,b)})},i.prototype.get=function(a){return m(a,!1,this._access_token)},i.prototype.getAttachment=function(a,b){return h(b),m(a,!0,this._access_token)},i.prototype.allAttachments=function(a){var b=this._access_token;return(new c.Queue).push(function(){return m(a,!1,b)}).push(function(a){return"application/vnd.google-apps.folder"===a.mimeType?{}:{enclosure:{}}})},a.addStorage("gdrive",i)}(jIO,Blob,RSVP,UriTemplate,JSON),function(a,b){"use strict";function c(b){if(!Array.isArray(b.storage_list))throw new a.util.jIOError("storage_list is not an Array",400);var c;for(this._storage_list=[],c=0;c<b.storage_list.length;c+=1)this._storage_list.push(a.createJIO(b.storage_list[c]))}c.prototype._getWithStorageIndex=function(){function b(b){g.push(void 0,function(c){if(c instanceof a.util.jIOError&&404===c.status_code)return e._storage_list[b].get.apply(e._storage_list[b],f).push(function(a){return d=b,a});throw c})}var c,d=0,e=this,f=arguments,g=this._storage_list[0].get.apply(this._storage_list[0],f);for(c=1;c<this._storage_list.length;c+=1)b(c);return g.push(function(a){return[d,a]})},c.prototype.get=function(){return this._getWithStorageIndex.apply(this,arguments).push(function(a){return a[1]})},c.prototype.allAttachments=function(){var a=arguments,b=this;return this._getWithStorageIndex.apply(this,arguments).push(function(c){var d=b._storage_list[c[0]];return d.allAttachments.apply(d,a)})},c.prototype.post=function(){return this._storage_list[0].post.apply(this._storage_list[0],arguments)},c.prototype.put=function(){var b=arguments,c=this;return this._getWithStorageIndex(b[0]).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return[0];throw b}).push(function(a){var d=c._storage_list[a[0]];return d.put.apply(d,b)})},c.prototype.remove=function(){var a=arguments,b=this;return this._getWithStorageIndex(a[0]).push(function(c){var d=b._storage_list[c[0]];return d.remove.apply(d,a)})},c.prototype.buildQuery=function(){var a,c,d=[],e={},f=this._storage_list.length;for(a=0;f>a;a+=1)c=this._storage_list[a],d.push(c.buildQuery.apply(c,arguments));return(new b.Queue).push(function(){return b.all(d)}).push(function(b){var c,d,g,h=[];for(f=b.length,a=0;f>a;a+=1)for(c=b[a],d=c.length,g=0;d>g;g+=1)e.hasOwnProperty(c[g].id)||(e[c[g].id]=null,h.push(c[g]));return h})},c.prototype.hasCapacity=function(a){var b,c,d,e;if("list"===a||"query"===a||"select"===a){for(d=!0,c=this._storage_list.length,b=0;c>b;b+=1)e=this._storage_list[b],d=d&&e.hasCapacity(a);return d}return!1},c.prototype.repair=function(){var a,c=[];for(a=0;a<this._storage_list.length;a+=1)c.push(this._storage_list[a].repair.apply(this._storage_list[a],arguments));return b.all(c)},c.prototype.getAttachment=function(){var a=arguments,b=this;return this._getWithStorageIndex.apply(this,arguments).push(function(c){var d=b._storage_list[c[0]];return d.getAttachment.apply(d,a)})},c.prototype.putAttachment=function(){var a=arguments,b=this;return this._getWithStorageIndex.apply(this,arguments).push(function(c){var d=b._storage_list[c[0]];return d.putAttachment.apply(d,a)})},c.prototype.removeAttachment=function(){var a=arguments,b=this;return this._getWithStorageIndex.apply(this,arguments).push(function(c){var d=b._storage_list[c[0]];return d.removeAttachment.apply(d,a)})},a.addStorage("union",c)}(jIO,RSVP),function(a,b,c,d,e,f,g,h){"use strict";function i(b){return(new d.Queue).push(function(){return a.util.ajax({type:"GET",url:b._url,xhrFields:{withCredentials:b._thisCredentials},headers:b._headers})}).push(function(a){return JSON.parse(a.target.responseText)})}function j(c,e,f){return void 0===f&&(f={}),i(c).push(function(g){return(new d.Queue).push(function(){return a.util.ajax({type:"GET",url:b.parse(g._links.traverse.href).expand({relative_url:e,view:f._view}),xhrFields:{withCredentials:c._thisCredentials},headers:c._headers})}).push(void 0,function(b){if(void 0!==b.target&&404===b.target.status)throw new a.util.jIOError("Cannot find document: "+e,404);throw b})})}function k(a){return(new d.Queue).push(function(){var b,c,d,f,g=a._embedded._view,h={portal_type:a._links.type.name},i={};a._links.hasOwnProperty("parent")&&(h.parent_relative_url=new e(a._links.parent.href).segment(2)),i.form_id={key:[g.form_id.key],"default":g.form_id["default"]};for(c in g)g.hasOwnProperty(c)&&(b=g[c],d=0,0===c.indexOf("my_")&&b.editable&&(d=3),0===c.indexOf("your_")&&(d=5),0!==d&&r.hasOwnProperty(b.type)&&(i[c.substring(d)]={"default":b["default"],key:b.key},h[c.substring(d)]=b["default"]));return f={data:h,form_data:i},g.hasOwnProperty("_actions")&&g._actions.hasOwnProperty("put")&&(f.action_href=g._actions.put.href),f})}function l(b,c){return b.getAttachment(c,"view").push(function(b){return a.util.readBlobAsText(b)}).push(function(a){return JSON.parse(a.target.result)}).push(function(a){return k(a)})}function m(a){if("string"!=typeof a.url||!a.url)throw new TypeError("ERP5 'url' must be a string which contains more than one character.");this._url=a.url,this._default_view_reference=a.default_view_reference,this._headers=null,this._thisCredentials=!0,void 0!==a.login&&void 0!==a.password&&(this._headers={Authorization:"Basic "+btoa(a.login+":"+a.password)},this._thisCredentials=!1)}function n(a){return a.data}function o(a){return a instanceof g&&void 0===a.operator&&"local_roles"===a.key?a.value:void 0}function p(a){if(a instanceof g&&void 0===a.operator&&void 0!==a.key&&0===a.key.indexOf("selection_domain_")){var b={};return b[a.key.slice("selection_domain_".length)]=a.value,b}}function q(a){var b,c,d=!0,e=[];if(a instanceof h&&"OR"===a.operator){for(b=0;b<a.query_list.length;b+=1)c=a.query_list[b],c instanceof g&&void 0!==c.key&&"local_roles"===c.key?e.push(c.value):d=!1;if(d)return e}}var r={StringField:null,EmailField:null,IntegerField:null,FloatField:null,TextAreaField:null};m.prototype.get=function(a){return l(this,a).push(function(a){return n(a)})},m.prototype.bulk=function(b){var e,f=this,g=[];for(e=0;e<b.length;e+=1){if("get"!==b[e].method)throw new Error("ERP5Storage: not supported "+b[e].method+" in bulk");g.push({relative_url:b[e].parameter_list[0],view:f._default_view_reference})}return i(f).push(function(b){var d=new c;return d.append("bulk_list",JSON.stringify(g)),a.util.ajax({type:"POST",url:b._actions.bulk.href,data:d,xhrFields:{withCredentials:f._thisCredentials},headers:f._headers})}).push(function(a){function b(a){return k(a).push(function(a){return n(a)})}var c=[],f=JSON.parse(a.target.responseText);for(e=0;e<f.result_list.length;e+=1)c.push(b(f.result_list[e]));return d.all(c)})},m.prototype.post=function(b){var d,f=this;return i(this).push(function(d){var e=new c;return e.append("portal_type",b.portal_type),e.append("parent_relative_url",b.parent_relative_url),a.util.ajax({type:"POST",url:d._actions.add.href,data:e,xhrFields:{withCredentials:f._thisCredentials},headers:f._headers})}).push(function(a){var c=a.target.getResponseHeader("X-Location"),g=new e(c);return d=g.segment(2),f.put(d,b)}).push(function(){return d})},m.prototype.put=function(b,c){var d=this;return l(d,b).push(function(e){var g,h=e.form_data,i={};i[h.form_id.key]=h.form_id["default"];for(g in c)if(c.hasOwnProperty(g)){if("form_id"===g)throw new a.util.jIOError("ERP5: forbidden property: "+g,400);if("portal_type"!==g&&"parent_relative_url"!==g){if(!h.hasOwnProperty(g))throw new a.util.jIOError("ERP5: can not store property: "+g,400);i[h[g].key]=c[g]}}if(!e.hasOwnProperty("action_href"))throw new a.util.jIOError("ERP5: can not modify document: "+b,403);return d.putAttachment(b,e.action_href,new f([JSON.stringify(i)],{type:"application/json"}))})},m.prototype.allAttachments=function(a){var b=this;return j(this,a).push(function(){return void 0===b._default_view_reference?{links:{}}:{view:{},links:{}}})},m.prototype.getAttachment=function(b,c,e){var g=this;if(void 0===e&&(e={}),"view"===c){if(void 0===this._default_view_reference)throw new a.util.jIOError("Cannot find attachment view for: "+b,404);return j(this,b,{_view:this._default_view_reference}).push(function(a){var b=JSON.parse(a.target.responseText);return new f([JSON.stringify(b)],{type:"application/hal+json"})})}if("links"===c)return j(this,b).push(function(a){return new f([JSON.stringify(JSON.parse(a.target.responseText))],{type:"application/hal+json"})});if(0===c.indexOf(this._url))return(new d.Queue).push(function(){var b,d,f,h={type:"GET",dataType:"blob",url:c,xhrFields:{withCredentials:g._thisCredentials},headers:g._headers};if(void 0!==e.start||void 0!==e.end){if(b=e.start||0,d=e.end,void 0!==d&&0>d)throw new a.util.jIOError("end must be positive",400);if(0>b)f="bytes="+b;else if(void 0===d)f="bytes="+b+"-";else{if(b>d)throw new a.util.jIOError("start is greater than end",400);f="bytes="+b+"-"+d}void 0===g._headers?h.headers={Range:f}:h.headers.Range=f}return a.util.ajax(h)}).push(function(a){return void 0===a.target.response?new f([a.target.responseText],{type:a.target.getResponseHeader("Content-Type")}):a.target.response});throw new a.util.jIOError("ERP5: not support get attachment: "+c,400)},m.prototype.putAttachment=function(b,e,f){var g=this;if(0!==e.indexOf(this._url))throw new a.util.jIOError("Can not store outside ERP5: "+e,400);return(new d.Queue).push(function(){return a.util.readBlobAsText(f)}).push(function(b){var d,f,h,i,j=JSON.parse(b.target.result),k=new c;for(h in j)if(j.hasOwnProperty(h))for(d=Array.isArray(j[h])?j[h]:[j[h]],f=0;f<d.length;f+=1)i=d[f],"object"==typeof i?k.append(h,a.util.dataURItoBlob(i.url),i.file_name):k.append(h,i);return a.util.ajax({type:"POST",url:e,data:k,dataType:"blob",xhrFields:{withCredentials:g._thisCredentials},headers:g._headers})})},m.prototype.hasCapacity=function(a){return"list"===a||"query"===a||"select"===a||"limit"===a||"sort"===a},m.prototype.buildQuery=function(c){var d=this;return i(this).push(function(e){var f,g,i,j,k,l,m,n=c.query,r=!1,s=[];if(c.query)if(i=a.QueryFactory.create(c.query),k=o(i))n=void 0,l=k;else if(k=p(i))n=void 0,m=k;else if(k=q(i))n=void 0,l=k;else if(i instanceof h&&"AND"===i.operator)for(f=0;f<i.query_list.length;f+=1)if(j=i.query_list[f],r||(k=o(j),k?(l=k,i.query_list.splice(f,1),n=a.Query.objectToSearchText(i),r=!0):(k=q(j),k&&(l=k,i.query_list.splice(f,1),n=a.Query.objectToSearchText(i),r=!0))),k=p(j)){if(i.query_list.splice(f,1),n=a.Query.objectToSearchText(i),m)for(g in k)k.hasOwnProperty(g)&&(m[g]=k[g]);else m=k;f-=1}if(c.sort_on)for(f=0;f<c.sort_on.length;f+=1)s.push(JSON.stringify(c.sort_on[f]));return m&&(m=JSON.stringify(m)),a.util.ajax({type:"GET",url:b.parse(e._links.raw_search.href).expand({query:n,select_list:c.select_list||["title","reference"],limit:c.limit,sort_on:s,local_roles:l,selection_domain:m}),xhrFields:{withCredentials:d._thisCredentials},headers:d._headers})}).push(function(a){return JSON.parse(a.target.responseText)}).push(function(a){var b,c,d,f=a._embedded.contents,g=f.length,h=[];for(b=0;g>b;b+=1)d=f[b],c=new e(d._links.self.href),delete d._links,h.push({id:c.segment(2),value:d});return h})},a.addStorage("erp5",m)}(jIO,UriTemplate,FormData,RSVP,URI,Blob,SimpleQuery,ComplexQuery),function(a,b,c){"use strict";function d(a){return c.JIODate(new Date(a).toISOString())}function e(b,c){var e;for(e in c.schema)if(c.schema.hasOwnProperty(e)){if("string"!==c.schema[e].type||"date-time"!==c.schema[e].format)throw new a.util.jIOError("Wrong schema for property: "+e,400);b._key_schema.key_set[e]={read_from:e,cast_to:"dateType"},void 0===b._key_schema.cast_lookup.dateType&&(b._key_schema.cast_lookup.dateType=d)}}function f(b){this._sub_storage=a.createJIO(b.sub_storage),this._key_schema={key_set:{},cast_lookup:{}},e(this,b)}f.prototype.get=function(){return this._sub_storage.get.apply(this._sub_storage,arguments)},f.prototype.allAttachments=function(){return this._sub_storage.allAttachments.apply(this._sub_storage,arguments)},f.prototype.post=function(){return this._sub_storage.post.apply(this._sub_storage,arguments)},f.prototype.put=function(){return this._sub_storage.put.apply(this._sub_storage,arguments)},f.prototype.remove=function(){return this._sub_storage.remove.apply(this._sub_storage,arguments)},f.prototype.getAttachment=function(){return this._sub_storage.getAttachment.apply(this._sub_storage,arguments)},f.prototype.putAttachment=function(){return this._sub_storage.putAttachment.apply(this._sub_storage,arguments)},f.prototype.removeAttachment=function(){return this._sub_storage.removeAttachment.apply(this._sub_storage,arguments)},f.prototype.repair=function(){return this._sub_storage.repair.apply(this._sub_storage,arguments)},f.prototype.hasCapacity=function(a){var b=["limit","sort","select","query"];return-1!==b.indexOf(a)?!0:"list"===a?this._sub_storage.hasCapacity(a):!1},f.prototype.buildQuery=function(c){var d=this._sub_storage,e=this,f={},g=!1,h=!1;if(d.hasCapacity("list")){try{void 0!==c.query&&!d.hasCapacity("query")||void 0!==c.sort_on&&!d.hasCapacity("sort")||void 0!==c.select_list&&!d.hasCapacity("select")||void 0!==c.limit&&!d.hasCapacity("limit")||(f.query=c.query,f.sort_on=c.sort_on,f.select_list=c.select_list,f.limit=c.limit)}catch(i){if(!(i instanceof a.util.jIOError&&501===i.status_code))throw i;g=!0}try{(g||c.include_docs===!0)&&d.hasCapacity("include")&&(f.include_docs=!0)}catch(i){if(!(i instanceof a.util.jIOError&&501===i.status_code))throw i;h=!0}return d.buildQuery(f).push(function(c){function e(b){var e=c[b].id;return d.get(e).push(function(a){return a._id=e,a},function(b){if(!(b instanceof a.util.jIOError&&404===b.status_code))throw b})}var f,g,i=[c];if(h){for(f=c.length,g=0;f>g;g+=1)i.push(e(g));c=b.all(i)}return c}).push(function(a){var b,c,d;if(h){for(b=a[0],c=b.length,d=0;c>d;d+=1)b[d].doc=a[d+1];a=b}return a}).push(function(b){var d,f,h=[];if(g){for(d=b.length,f=0;d>f;f+=1)b[f].doc.__id=b[f].id,h.push(b[f].doc);c.select_list&&c.select_list.push("__id"),b=a.QueryFactory.create(c.query||"",e._key_schema).exec(h,c)}return b}).push(function(a){var b,d,e,f=[];if(g){for(d=a.length,e=0;d>e;e+=1){if(b={id:a[e].__id,value:c.select_list?a[e]:{},doc:{}},c.select_list&&delete b.value.__id,c.include_docs)throw new Error("QueryStorage does not support include docs");f.push(b)}a=f}return a})}},a.addStorage("query",f)}(jIO,RSVP,jiodate),function(a,b,c){"use strict";function d(b){this._sub_storage=a.createJIO(b.sub_storage)}function e(a,b){return-1!==a.indexOf(b,a.length-b.length)}var f=".json",g="/.jio_documents/",h="/";d.prototype.get=function(c){var d=this;return(new b.Queue).push(function(){return d._sub_storage.getAttachment(g,c+f,{format:"json"})}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return d._sub_storage.allAttachments(h).push(function(b){if(b.hasOwnProperty(c))return{};throw new a.util.jIOError("Cannot find document "+c,404)});throw b})},d.prototype.allAttachments=function(b){var c=this;return c._sub_storage.allAttachments(h).push(function(d){return d.hasOwnProperty(b)?{enclosure:{}}:c._sub_storage.getAttachment(g,b+f).push(function(){return{}},function(c){if(c instanceof a.util.jIOError&&404===c.status_code)throw new a.util.jIOError("Cannot find document "+b,404);throw c})})},d.prototype.put=function(b,d){var e=this;return e._sub_storage.putAttachment(g,b+f,new c([JSON.stringify(d)],{type:"application/json"})).push(void 0,function(h){if(h instanceof a.util.jIOError&&404===h.status_code)return e._sub_storage.put(g,{}).push(function(){return e._sub_storage.putAttachment(g,b+f,new c([JSON.stringify(d)],{type:"application/json"}))});throw h}).push(function(){return b})},d.prototype.remove=function(c){var d=this,e=!1;return(new b.Queue).push(function(){return d._sub_storage.removeAttachment(h,c)}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return void(e=!0);throw b}).push(function(){return d._sub_storage.removeAttachment(g,c+f)}).push(void 0,function(b){if(!e&&b instanceof a.util.jIOError&&404===b.status_code)return c;throw b})},d.prototype.hasCapacity=function(a){return"list"===a},d.prototype.buildQuery=function(){var c={},d=this;return(new b.Queue).push(function(){return d._sub_storage.allAttachments(g)}).push(function(a){var b;for(b in a)a.hasOwnProperty(b)&&e(b,f)&&(c[b.substring(0,b.length-f.length)]=null)},function(b){if(!(b instanceof a.util.jIOError&&404===b.status_code))throw b}).push(function(){return d._sub_storage.allAttachments(h)}).push(function(a){var b;for(b in a)a.hasOwnProperty(b)&&(c[b]=null)}).push(function(){var a,b=[];for(a in c)c.hasOwnProperty(a)&&b.push({id:a,value:{}});return b})},d.prototype.getAttachment=function(b,c){if("enclosure"!==c)throw new a.util.jIOError("Only support 'enclosure' attachment",400);return this._sub_storage.getAttachment(h,b)},d.prototype.putAttachment=function(b,c,d){if("enclosure"!==c)throw new a.util.jIOError("Only support 'enclosure' attachment",400);return this._sub_storage.putAttachment(h,b,d)},d.prototype.removeAttachment=function(b,c){if("enclosure"!==c)throw new a.util.jIOError("Only support 'enclosure' attachment",400);return this._sub_storage.removeAttachment(h,b)},d.prototype.repair=function(){return this._sub_storage.repair.apply(this._sub_storage,arguments)},a.addStorage("drivetojiomapping",d)}(jIO,RSVP,Blob),function(a,b,c,d,e){"use strict";function f(b){this._sub_storage=a.createJIO(b.sub_storage),this._document_id=b.document_id,this._repair_attachment=b.repair_attachment||!1}function g(a,b){return void 0===b?"jio_document/"+k(a)+h:"jio_attachment/"+k(a)+"/"+k(b)}var h=".json",i=new RegExp("^jio_document/([\\w=]+)"+h+"$"),j=new RegExp("^jio_attachment/([\\w=]+)/([\\w=]+)$"),k=function(a){return window.btoa(d(encodeURIComponent(a)))},l=function(a){return decodeURIComponent(e(window.atob(a)))};f.prototype.get=function(a){return this._sub_storage.getAttachment(this._document_id,g(a),{format:"json"})},f.prototype.allAttachments=function(a){return this._sub_storage.allAttachments(this._document_id).push(function(b){var c,d,e={};for(d in b)if(b.hasOwnProperty(d)&&j.test(d)){c=j.exec(d);try{l(c[1])===a&&(e[l(c[2])]={})}catch(f){if(!f instanceof ReferenceError)throw f}}return e})},f.prototype.put=function(a,c){return this._sub_storage.putAttachment(this._document_id,g(a),new b([JSON.stringify(c)],{type:"application/json"})).push(function(){return a})},f.prototype.remove=function(a){var b=this;return this.allAttachments(a).push(function(d){var e,f=[];for(e in d)d.hasOwnProperty(e)&&f.push(b.removeAttachment(a,e));return c.all(f)}).push(function(){return b._sub_storage.removeAttachment(b._document_id,g(a))}).push(function(){return a})},f.prototype.repair=function(){var a=this;return this._sub_storage.repair.apply(this._sub_storage,arguments).push(function(b){return a._repair_attachment?a._sub_storage.allAttachments(a._document_id).push(function(b){var d,e,f,g,h=[],k={},m={};for(g in b)if(b.hasOwnProperty(g))if(d=void 0,e=void 0,i.test(g)){try{d=l(i.exec(g)[1])}catch(n){if(!n instanceof ReferenceError)throw n}void 0!==d&&(k[d]=null)}else if(j.test(g)){f=j.exec(g);try{d=l(f[1]),e=l(f[2])}catch(n){if(!n instanceof ReferenceError)throw n}void 0!==e&&(k.hasOwnProperty(d)||(m.hasOwnProperty(d)||(m[d]={}),m[d][e]=null))}for(d in m)if(m.hasOwnProperty(d)&&!k.hasOwnProperty(d))for(e in m[d])m[d].hasOwnProperty(e)&&h.push(a.removeAttachment(d,e));
return c.all(h)}):b})},f.prototype.hasCapacity=function(a){return"list"===a},f.prototype.buildQuery=function(){return this._sub_storage.allAttachments(this._document_id).push(function(a){var b,c=[];for(b in a)if(a.hasOwnProperty(b)&&i.test(b))try{c.push({id:l(i.exec(b)[1]),value:{}})}catch(d){if(!d instanceof ReferenceError)throw d}return c})},f.prototype.getAttachment=function(a,b){return this._sub_storage.getAttachment(this._document_id,g(a,b))},f.prototype.putAttachment=function(a,b,c){return this._sub_storage.putAttachment(this._document_id,g(a,b),c)},f.prototype.removeAttachment=function(a,b){return this._sub_storage.removeAttachment(this._document_id,g(a,b))},a.addStorage("document",f)}(jIO,Blob,RSVP,unescape,escape),function(a,b,c,d){"use strict";function e(a){a.sessiononly===!0?this._storage=b:this._storage=c}function f(b){if("/"!==b)throw new a.util.jIOError("id "+b+" is forbidden (!== /)",400)}e.prototype.get=function(a){return f(a),{}},e.prototype.allAttachments=function(a){f(a);var b,c={};for(b in this._storage)this._storage.hasOwnProperty(b)&&(c[b]={});return c},e.prototype.getAttachment=function(b,c){f(b);var d=this._storage.getItem(c);if(null===d)throw new a.util.jIOError("Cannot find attachment "+c,404);return a.util.dataURItoBlob(d)},e.prototype.putAttachment=function(b,c,e){var g=this;return f(b),(new d.Queue).push(function(){return a.util.readBlobAsDataURL(e)}).push(function(a){g._storage.setItem(c,a.target.result)})},e.prototype.removeAttachment=function(a,b){return f(a),this._storage.removeItem(b)},e.prototype.hasCapacity=function(a){return"list"===a},e.prototype.buildQuery=function(){return[{id:"/",value:{}}]},a.addStorage("local",e)}(jIO,sessionStorage,localStorage,RSVP),function(a,b,c,d,e,f,g,h){"use strict";function i(a){if("string"!=typeof a.database||""===a.database)throw new TypeError("IndexedDBStorage 'database' description property must be a non-empty string");this._database_name="jio:"+a.database}function j(a){return a.join("_")}function k(a){var b,c=a.target.result;b=c.createObjectStore("metadata",{keyPath:"_id",autoIncrement:!1}),b.createIndex("_id","_id",{unique:!0}),b=c.createObjectStore("attachment",{keyPath:"_key_path",autoIncrement:!1}),b.createIndex("_id","_id",{unique:!1}),b=c.createObjectStore("blob",{keyPath:"_key_path",autoIncrement:!1}),b.createIndex("_id_attachment",["_id","_attachment"],{unique:!1}),b.createIndex("_id","_id",{unique:!1})}function l(b){function d(b,c){var d=a.open(e);d.onerror=function(a){d.result&&d.result.close(),c(void 0!==a&&a.target instanceof g&&a.target.error instanceof h?"Connection to: "+e+" failed: "+a.target.error.message:a)},d.onabort=function(){d.result.close(),c("Aborting connection to: "+e)},d.ontimeout=function(){d.result.close(),c("Connection to: "+e+" timeout")},d.onblocked=function(){d.result.close(),c("Connection to: "+e+" was blocked")},d.onupgradeneeded=k,d.onversionchange=function(){d.result.close(),c(e+" was upgraded")},d.onsuccess=function(){b(d.result)}}var e=b._database_name;return(new c.Queue).push(function(){return new c.Promise(d)})}function m(a,b,c,d){var e=a.transaction(b,c);return d!==!1&&(e.oncomplete=function(){a.close()}),e.onabort=function(){a.close()},e}function n(a,b,c,d){a.onerror=function(b){a.transaction&&a.transaction.abort(),d(b)},a.onsuccess=function(a){var e=a.target.result;if(e){try{b(e)}catch(f){d(f)}e["continue"]()}else c()}}function o(a,c,d,e){var f=a.get(c);f.onerror=e,f.onsuccess=function(){f.result?d(f.result):e(new b.util.jIOError("IndexedDB: cannot find object '"+c+"' in the '"+a.name+"' store",404))}}function p(a,b,c){a.onerror=c,a.onsuccess=function(){b(a.result)}}function q(a){a["delete"]()}function r(a,b,c,d,e){function g(){n(a.objectStore("blob").index("_id_attachment").openCursor(f.only([b,c])),q,d,e)}p(a.objectStore("attachment")["delete"](j([b,c])),g,e)}var s=2e6;i.prototype.hasCapacity=function(a){return"list"===a||"include"===a},i.prototype.buildQuery=function(a){function b(a){e.push({id:a.key,value:{},doc:a.value.doc})}function d(a){e.push({id:a.key,value:{}})}var e=[];return l(this).push(function(e){return new c.Promise(function(c,f){var g=m(e,["metadata"],"readonly");a.include_docs===!0?n(g.objectStore("metadata").index("_id").openCursor(),b,c,f):n(g.objectStore("metadata").index("_id").openKeyCursor(),d,c,f)})}).push(function(){return e})},i.prototype.get=function(a){return l(this).push(function(b){return new c.Promise(function(c,d){var e=m(b,["metadata"],"readonly");o(e.objectStore("metadata"),a,c,d)})}).push(function(a){return a.doc})},i.prototype.allAttachments=function(a){function b(a){d[a.value._attachment]={}}var d={};return l(this).push(function(d){return new c.Promise(function(c,e){function g(){n(h.objectStore("attachment").index("_id").openCursor(f.only(a)),b,c,e)}var h=m(d,["metadata","attachment"],"readonly");o(h.objectStore("metadata"),a,g,e)})}).push(function(){return d})},i.prototype.put=function(a,b){return l(this).push(function(d){return new c.Promise(function(c,e){var f=m(d,["metadata"],"readwrite");p(f.objectStore("metadata").put({_id:a,doc:b}),c,e)})})},i.prototype.remove=function(a){var b=0;return l(this).push(function(d){return new c.Promise(function(c,e){function g(){2>b?b+=1:c()}var h=m(d,["metadata","attachment","blob"],"readwrite");p(h.objectStore("metadata")["delete"](a),g,e),n(h.objectStore("attachment").index("_id").openCursor(f.only(a)),q,g,e),n(h.objectStore("blob").index("_id").openCursor(f.only(a)),q,g,e)})})},i.prototype.getAttachment=function(a,f,g){var h,i,k,n;return void 0===g&&(g={}),l(this).push(function(d){return new c.Promise(function(c,l){function p(d){function m(a){void 0!==a.blob&&u.push(a),c(u)}function p(b){return function(c){c&&u.push(c),b+=1,o(v,j([a,f,b]),r>=b?p(b):m,l)}}var q,r,t=d.info.length,u=[],v=h.objectStore("blob");if(i=d.info.content_type,k=g.start||0,n=g.end||t,n>t&&(n=t),0>k||0>n)throw new b.util.jIOError("_start and _end must be positive",400);if(k>n)throw new b.util.jIOError("_start is greater than _end",400);q=e.floor(k/s),r=e.floor(n/s)-1,n%s===0&&(r-=1),p(q-1)()}h=m(d,["attachment","blob"],"readonly"),o(h.objectStore("attachment"),j([a,f]),p,l)})}).push(function(a){var b,c,f,h=[],j=a.length;for(c=0;j>c;c+=1)h.push(a[c].blob);return void 0===g.start&&void 0===g.end?new d(h,{type:i}):(f=e.floor(k/s)*s,b=new d(h,{type:"application/octet-stream"}),b.slice(k-f,n-f,"application/octet-stream"))})},i.prototype.putAttachment=function(a,d,e){var f,g,h=[];return l(this).push(function(a){return g=a,b.util.readBlobAsArrayBuffer(e)}).push(function(b){for(var i=b.target.result,k=e.size,l=0;k>l;)h.push(i.slice(l,l+s)),l+=s;return f=m(g,["attachment","blob"],"readwrite"),new c.Promise(function(b,c){function g(){function g(e){return function(){e+=1,p(l.put({_key_path:j([a,d,e]),_id:a,_attachment:d,_part:e,blob:h[e]}),i>e?g(e):b,c)}}var i=h.length-1,k=f.objectStore("attachment"),l=f.objectStore("blob");p(k.put({_key_path:j([a,d]),_id:a,_attachment:d,info:{content_type:e.type,length:e.size}}),g(-1),c)}r(f,a,d,g,c)})})},i.prototype.removeAttachment=function(a,b){return l(this).push(function(d){var e=m(d,["attachment","blob"],"readwrite");return new c.Promise(function(c,d){r(e,a,b,c,d)})})},b.addStorage("indexeddb",i)}(indexedDB,jIO,RSVP,Blob,Math,IDBKeyRange,IDBOpenDBRequest,DOMError),function(a,b,c,d,e,f,g){"use strict";function h(b){this._key=b.key,this._jsonKey=!0,this._sub_storage=a.createJIO(b.sub_storage)}function i(a){return(new b.Queue).push(function(){return e.subtle.importKey("jwk",a._key,"AES-GCM",!1,["encrypt","decrypt"])}).push(function(b){a._key=b,a._jsonKey=!1})}var j="application/x-jio-aes-gcm-encryption";h.prototype.get=function(){return this._sub_storage.get.apply(this._sub_storage,arguments)},h.prototype.post=function(){return this._sub_storage.post.apply(this._sub_storage,arguments)},h.prototype.put=function(){return this._sub_storage.put.apply(this._sub_storage,arguments)},h.prototype.remove=function(){return this._sub_storage.remove.apply(this._sub_storage,arguments)},h.prototype.hasCapacity=function(){return this._sub_storage.hasCapacity.apply(this._sub_storage,arguments)},h.prototype.buildQuery=function(){return this._sub_storage.buildQuery.apply(this._sub_storage,arguments)},h.prototype.putAttachment=function(c,h,k){var l=e.getRandomValues(new f(12)),m=this;return(new b.Queue).push(function(){return m._jsonKey===!0?i(m):void 0}).push(function(){return a.util.readBlobAsDataURL(k)}).push(function(a){var b,c=a.target.result.length,d=new g(c),h=new f(d);for(a=a.target.result,b=0;c>b;b+=1)h[b]=a.charCodeAt(b);return e.subtle.encrypt({name:"AES-GCM",iv:l},m._key,d)}).push(function(a){var b=new d([l,a],{type:j});return m._sub_storage.putAttachment(c,h,b)})},h.prototype.getAttachment=function(d,g){var h=this;return h._sub_storage.getAttachment(d,g).push(function(d){return d.type!==j?d:(new b.Queue).push(function(){return h._jsonKey===!0?i(h):void 0}).push(function(){return a.util.readBlobAsArrayBuffer(d)}).push(function(g){var i;return g=g.target.result,i=new f(g.slice(0,12)),(new b.Queue).push(function(){return e.subtle.decrypt({name:"AES-GCM",iv:i},h._key,g.slice(12))}).push(function(b){return b=String.fromCharCode.apply(null,new f(b)),a.util.dataURItoBlob(b)}).push(void 0,function(a){if(a instanceof c)return d;throw a})})})},h.prototype.removeAttachment=function(){return this._sub_storage.removeAttachment.apply(this._sub_storage,arguments)},h.prototype.allAttachments=function(){return this._sub_storage.allAttachments.apply(this._sub_storage,arguments)},a.addStorage("crypt",h)}(jIO,RSVP,DOMException,Blob,crypto,Uint8Array,ArrayBuffer),function(a,b,c,d){"use strict";function e(a,c,d){return new b.Promise(function(b,e){a.transaction(function(a){function f(a,c){j.push(c),j.length===i&&b(j)}function g(a,b){return e(b),!0}var h,i=c.length,j=[];for(h=0;i>h;h+=1)a.executeSql(c[h],d[h],f,g)},function(a,b){e(b)})})}function f(a){var c=["CREATE TABLE IF NOT EXISTS document(id VARCHAR PRIMARY KEY NOT NULL, data TEXT)","CREATE TABLE IF NOT EXISTS attachment(id VARCHAR, attachment VARCHAR, part INT, blob TEXT)","CREATE TRIGGER IF NOT EXISTS removeAttachment BEFORE DELETE ON document FOR EACH ROW BEGIN DELETE from attachment WHERE id = OLD.id;END;","CREATE INDEX IF NOT EXISTS index_document ON document (id);","CREATE INDEX IF NOT EXISTS index_attachment ON attachment (id, attachment);"];return(new b.Queue).push(function(){return e(a,c,[])})}function g(a){if("string"!=typeof a.database||!a.database)throw new TypeError("database must be a string which contains more than one character.");if(this._database=d("jio:"+a.database,"1.0","",2097152),a.blob_length&&("number"!=typeof a.blob_length||a.blob_length<20))throw new TypeError("blob_len parameter must be a number >= 20");this._blob_length=a.blob_length||2e6,this._init_db_promise=f(this._database)}function h(b,c,d,e){e.push(function(){return a.util.readBlobAsDataURL(b)}).push(function(a){c[d+2].push(a.target.result)})}g.prototype.put=function(a,c){var d=this._database,f=this,g=JSON.stringify(c);return(new b.Queue).push(function(){return f._init_db_promise}).push(function(){return e(d,["INSERT OR REPLACE INTO document(id, data) VALUES(?,?)"],[[a,g]])}).push(function(){return a})},g.prototype.remove=function(c){var d=this._database,f=this;return(new b.Queue).push(function(){return f._init_db_promise}).push(function(){return e(d,["DELETE FROM document WHERE id = ?"],[[c]])}).push(function(b){if(0===b[0].rowsAffected)throw new a.util.jIOError("Cannot find document",404);return c})},g.prototype.get=function(c){var d=this._database,f=this;return(new b.Queue).push(function(){return f._init_db_promise}).push(function(){return e(d,["SELECT data FROM document WHERE id = ?"],[[c]])}).push(function(b){if(0===b[0].rows.length)throw new a.util.jIOError("Cannot find document",404);return JSON.parse(b[0].rows[0].data)})},g.prototype.allAttachments=function(c){var d=this._database,f=this;return(new b.Queue).push(function(){return f._init_db_promise}).push(function(){return e(d,["SELECT id FROM document WHERE id = ?","SELECT DISTINCT attachment FROM attachment WHERE id = ?"],[[c],[c]])}).push(function(b){if(0===b[0].rows.length)throw new a.util.jIOError("Cannot find document",404);var c,d=b[1].rows.length,e={};for(c=0;d>c;c+=1)e[b[1].rows[c].attachment]={};return e})},g.prototype.putAttachment=function(c,d,f){var g=this._database,i=this,j=this._blob_length;return(new b.Queue).push(function(){return i._init_db_promise}).push(function(){return e(g,["SELECT id FROM document WHERE id = ?"],[[c]])}).push(function(i){var k,l,m=[],n=[],o=f.size,p=new b.Queue;if(0===i[0].rows.length)throw new a.util.jIOError("Cannot access subdocument",404);for(m.push("DELETE FROM attachment WHERE id = ? AND attachment = ?"),n.push([c,d]),m.push("INSERT INTO attachment(id, attachment, part, blob)VALUES(?, ?, ?, ?)"),n.push([c,d,-1,f.type||"application/octet-stream"]),k=0,l=0;o>k;k+=j,l+=1)m.push("INSERT INTO attachment(id, attachment, part, blob)VALUES(?, ?, ?, ?)"),n.push([c,d,l]),h(f.slice(k,k+j),n,l,p);return p.push(function(){return e(g,m,n)}),p})},g.prototype.getAttachment=function(d,f,g){var h,i,j,k,l=this._database,m=this,n=this._blob_length;if(void 0===g&&(g={}),h=g.start||0,i=g.end||-1,0>h||void 0!==g.end&&g.end<0)throw new a.util.jIOError("_start and _end must be positive",400);if(h>i&&-1!==i)throw new a.util.jIOError("_start is greater than _end",400);return j=Math.floor(h/n),0===h&&(j-=1),k=Math.floor(i/n),i%n===0&&(k-=1),(new b.Queue).push(function(){return m._init_db_promise}).push(function(){var a="SELECT part, blob FROM attachment WHERE id = ? AND attachment = ? AND part >= ?",b=[d,f,j];return-1!==i&&(a+=" AND part <= ?",b.push(k)),e(l,[a],[b])}).push(function(b){var d,e,f,k,l=[];if(e=b[0].rows,0===e.length)throw new a.util.jIOError("Cannot find document",404);for(d=0;d<e.length;d+=1)-1===e[d].part?(k=e[d].blob,j+=1):l.push(a.util.dataURItoBlob(e[d].blob));return 0===h&&void 0===g.end?new c(l,{type:k}):(f=new c(l,{}),f.slice(h-j*n,-1===i?f.size:i-j*n,"application/octet-stream"))})},g.prototype.removeAttachment=function(c,d){var f=this._database,g=this;return(new b.Queue).push(function(){return g._init_db_promise}).push(function(){return e(f,["DELETE FROM attachment WHERE id = ? AND attachment = ?"],[[c,d]])}).push(function(b){if(0===b[0].rowsAffected)throw new a.util.jIOError("Cannot find document",404);return d})},g.prototype.hasCapacity=function(a){return"list"===a||"include"===a},g.prototype.buildQuery=function(a){var c=this._database,d=this,f="SELECT id";return(new b.Queue).push(function(){return d._init_db_promise}).push(function(){return void 0===a&&(a={}),a.include_docs===!0&&(f+=", data AS doc"),f+=" FROM document",e(c,[f],[[]])}).push(function(a){var b,c=[],d=a[0].rows.length;for(b=0;d>b;b+=1)c.push(a[0].rows[b]),c[b].value={},void 0!==c[b].doc&&(c[b].doc=JSON.parse(c[b].doc));return c})},a.addStorage("websql",g)}(jIO,RSVP,Blob,openDatabase),function(a,b,c,d,e,f,g,h){"use strict";function i(b,c,f){var h;if(b._no_sub_query_id)throw new a.util.jIOError("no sub query id active",404);if(!c)throw new a.util.jIOError("can not find document with "+f+" : undefined",404);return b._mapping_id_memory_dict[c]?b._mapping_id_memory_dict[c]:(h=new d({key:f,value:c,type:"simple"}),void 0!==b._query.query&&(h=new e({operator:"AND",query_list:[h,b._query.query],type:"complex"})),h=g.objectToSearchText(h),b._sub_storage.allDocs({query:h,sort_on:b._query.sort_on,select_list:b._query.select_list,limit:b._query.limit}).push(function(d){if(0===d.data.total_rows)throw new a.util.jIOError("Can not find document with ("+f+", "+c+")",404);if(d.data.total_rows>1)throw new TypeError("id must be unique field: "+f+", result:"+d.data.rows.toString());return b._mapping_id_memory_dict[c]=d.data.rows[0].id,d.data.rows[0].id}))}function j(b){var c,g=[];for(c in b._mapping_dict)if(b._mapping_dict.hasOwnProperty(c)){if("equalValue"===b._mapping_dict[c][0]){if(void 0===b._mapping_dict[c][1])throw new a.util.jIOError("equalValue has not parameter",400);b._default_mapping[c]=b._mapping_dict[c][1],g.push(new d({key:c,value:b._mapping_dict[c][1],type:"simple"}))}if("equalSubId"===b._mapping_dict[c][0]){if(void 0!==b._property_for_sub_id)throw new a.util.jIOError("equalSubId can be defined one time",400);b._property_for_sub_id=c}}"equalSubProperty"===b._map_id[0]&&(b._mapping_dict[b._map_id[1]]=["keep"]),void 0!==b._query.query&&g.push(f.create(b._query.query)),g.length>1?b._query.query=new e({type:"complex",query_list:g,operator:"AND"}):1===g.length&&(b._query.query=g[0])}function k(b){this._mapping_dict=b.property||{},this._sub_storage=a.createJIO(b.sub_storage),this._map_all_property=void 0!==b.map_all_property?b.map_all_property:!0,this._no_sub_query_id=b.no_sub_query_id,this._attachment_mapping_dict=b.attachment||{},this._query=b.query||{},this._map_id=b.id||["equalSubId"],this._id_mapped=void 0!==b.id?b.id[1]:!1,void 0!==this._query.query&&(this._query.query=f.create(this._query.query)),this._default_mapping={},this._mapping_id_memory_dict={},this._attachment_list=b.attachment_list||[],this._caching_dict={id:{}},j(this)}function l(a,b,d,e){var f=a._attachment_mapping_dict;return void 0!==f&&void 0!==f[d]&&void 0!==f[d][e]&&void 0!==f[d][e].uri_template?c.parse(f[d][e].uri_template).expand({id:b}):d}function m(a,c,d){return a._caching_dict.id.hasOwnProperty(c)?(new b.Queue).push(function(){return a._caching_dict.id[c]}):(new b.Queue).push(function(){var b=a._map_id||["equalSubId"];return a._property_for_sub_id&&void 0!==d&&d.hasOwnProperty(a._property_for_sub_id)?d[a._property_for_sub_id]:s[b[0]].mapToSubId(a,d,c,b[1])}).push(function(b){return a._caching_dict.id[c]=b,b})}function n(a,b,c,d,e){var f=a._mapping_dict[b]||["keep"];return s[f[0]].mapToSubProperty(b,c,d,f[1],e)}function o(a,b,c,d,e){var f=a._mapping_dict[b]||["keep"];return s[f[0]].mapToMainProperty(b,c,d,f[1],e)}function p(a,b,c){var d,e={},f=[a._id_mapped];for(d in a._mapping_dict)a._mapping_dict.hasOwnProperty(d)&&f.push(o(a,d,b,e,c));if(a._map_all_property)for(d in b)b.hasOwnProperty(d)&&f.indexOf(d)<0&&(e[d]=b[d]);return void 0!==a._map_for_sub_storage_id&&(e[a._map_for_sub_storage_id]=c),e}function q(a,b,c){var d,e={};for(d in b)b.hasOwnProperty(d)&&n(a,d,e,b,c);for(d in a._default_mapping)a._default_mapping.hasOwnProperty(d)&&(e[d]=a._default_mapping[d]);return"equalSubProperty"===a._map_id[0]&&void 0!==c&&(e[a._map_id[1]]=c),e}function r(b,c,d){return m(b,c[0]).push(function(e){c[0]=e;var f=c[1];c[1]=l(b,c[0],c[1],d);{if(!(b._attachment_list.length>0&&b._attachment_list.indexOf(f)<0))return b._sub_storage[d+"Attachment"].apply(b._sub_storage,c);if("get"===d)throw new a.util.jIOError("unhautorized attachment",404)}})}var s={equalSubProperty:{mapToSubProperty:function(a,b,c,d,e){return b[d]=c[a],d},mapToMainProperty:function(a,b,c,d,e){return b.hasOwnProperty(d)&&(c[a]=b[d]),d},mapToSubId:function(a,b,c,d){return void 0!==b&&a._property_for_sub_id&&b.hasOwnProperty(a._property_for_sub_id)?b[a._property_for_sub_id]:i(a,c,a._map_id[1])},mapToId:function(a,b,c,d){return b[d]}},equalValue:{mapToSubProperty:function(a,b,c,d){return b[a]=d,a},mapToMainProperty:function(a){return a}},ignore:{mapToSubProperty:function(){return!1},mapToMainProperty:function(a){return a}},equalSubId:{mapToSubProperty:function(a,b,c){return b[a]=c[a],a},mapToMainProperty:function(a,b,c,d,e){return void 0===e&&b.hasOwnProperty(a)?c[a]=b[a]:c[a]=e,a},mapToSubId:function(a,b,c,d){return c},mapToId:function(a,b,c){return c}},keep:{mapToSubProperty:function(a,b,c){return b[a]=c[a],a},mapToMainProperty:function(a,b,c){return c[a]=b[a],a}},switchPropertyValue:{mapToSubProperty:function(a,b,c,d){return b[d[0]]=d[1][c[a]],d[0]},mapToMainProperty:function(a,b,c,d){var e,f=b[d[0]];for(e in d[1])if(d[1].hasOwnProperty(e)&&f===d[1][e])return c[a]=e,a}}};k.prototype.get=function(a){var b=this;return m(this,a).push(function(a){return b._sub_storage.get(a).push(function(c){return p(b,c,a)})})},k.prototype.post=function(b){var c=q(this,b),d=b[this._property_for_sub_id],e=this;if(this._property_for_sub_id&&void 0!==d)return this._sub_storage.put(d,c);if(this._id_mapped&&void 0!==b[this._id_mapped])return m(e,d,b).push(function(a){return e._sub_storage.put(a,c)}).push(function(){return b[e._id_mapped]}).push(void 0,function(b){if(b instanceof a.util.jIOError)return e._sub_storage.post(c);throw b});throw new a.util.jIOError("post is not supported with id mapped",400)},k.prototype.put=function(b,c){var d=this,e=q(this,c,b);return m(this,b,c).push(function(a){return d._sub_storage.put(a,e)}).push(void 0,function(b){if(b instanceof a.util.jIOError&&404===b.status_code)return d._sub_storage.post(e);throw b}).push(function(){return b})},k.prototype.remove=function(a){var b=this;return m(this,a).push(function(a){return b._sub_storage.remove(a)}).push(function(){return a})},k.prototype.getAttachment=function(){return r(this,arguments,"get")},k.prototype.putAttachment=function(b,d,e){var f=this,g=f._attachment_mapping_dict;return void 0!==g&&void 0!==g[d]&&void 0!==g[d].put&&void 0!==g[d].put.erp5_put_template?m(f,b).push(function(b){var f=c.parse(g[d].put.erp5_put_template).expand({id:b}),i=new h;return i.append("field_my_file",e),i.append("form_id","File_view"),a.util.ajax({type:"POST",url:f,data:i,xhrFields:{withCredentials:!0}})}):r(this,arguments,"put",b).push(function(){return d})},k.prototype.removeAttachment=function(a,b){return r(this,arguments,"remove",a).push(function(){return b})},k.prototype.allAttachments=function(a){var b,c=this;return m(c,a).push(function(a){return b=a,c._sub_storage.allAttachments(b)}).push(function(a){var d,e,f={},g={};for(d in c._attachment_mapping_dict)c._attachment_mapping_dict.hasOwnProperty(d)&&(g[l(c,b,d,"get")]=d);for(d in a)a.hasOwnProperty(d)&&(c._attachment_list.length>0&&c._attachment_list.indexOf(d)<0||(g.hasOwnProperty(d)?f[g[d]]={}:f[d]={}));for(e=0;e<c._attachment_list.length;e+=1)f.hasOwnProperty(c._attachment_list[e])||(f[c._attachment_list[e]]={});return f})},k.prototype.hasCapacity=function(a){return this._sub_storage.hasCapacity(a)},k.prototype.repair=function(){return this._sub_storage.repair.apply(this._sub_storage,arguments)},k.prototype.bulk=function(a){function c(a){return m(d,a.parameter_list[0]).push(function(b){return{method:a.method,parameter_list:[b]}})}var d=this;return(new b.Queue).push(function(){var d=a.map(c);return b.all(d)}).push(function(a){return d._sub_storage.bulk(a)}).push(function(a){var b,c=[];for(b=0;b<a.length;b+=1)c.push(p(d,a[b]));return c})},k.prototype.buildQuery=function(a){function b(a){var c,d,e,f=[];if("complex"===a.type){for(c=0;c<a.query_list.length;c+=1)e=b(a.query_list[c]),e&&f.push(e);return a.query_list=f,a}return d=o(i,a.key,{},{}),void 0!==d?(a.key=d,a):!1}var c,d,h,i=this,j=[],k=[];if(void 0!==a.sort_on)for(c=0;c<a.sort_on.length;c+=1)h=o(this,a.sort_on[c][0],{},{}),h&&k.indexOf(h)<0&&k.push([h,a.sort_on[c][1]]);if(void 0!==this._query.sort_on)for(c=0;c<this._query.sort_on.length;c+=1)h=o(this,this._query.sort_on[c],{},{}),k.indexOf(h)<0&&k.push([h,a.sort_on[c][1]]);if(void 0!==a.select_list)for(c=0;c<a.select_list.length;c+=1)h=o(this,a.select_list[c],{},{}),h&&j.indexOf(h)<0&&j.push(h);if(void 0!==this._query.select_list)for(c=0;c<this._query.select_list;c+=1)h=this._query.select_list[c],j.indexOf(h)<0&&j.push(h);return this._id_mapped&&j.push(this._id_mapped),void 0!==a.query&&(d=b(f.create(a.query))),void 0!==this._query.query&&(void 0===d&&(d=this._query.query),d=new e({operator:"AND",query_list:[d,this._query.query],type:"complex"})),void 0!==d&&(d=g.objectToSearchText(d)),this._sub_storage.allDocs({query:d,select_list:j,sort_on:k,limit:a.limit}).push(function(a){var b,d=i._map_id||["equalSubId"];for(c=0;c<a.data.total_rows;c+=1)b=a.data.rows[c].value,a.data.rows[c].id=s[d[0]].mapToId(i,b,a.data.rows[c].id,d[1]),a.data.rows[c].value=p(i,b);return a.data.rows})},a.addStorage("mapping",k)}(jIO,RSVP,UriTemplate,SimpleQuery,ComplexQuery,QueryFactory,Query,FormData),function(a,b,c){"use strict";function d(a){if("string"!=typeof a.access_token||!a.access_token)throw new TypeError("Access Token must be a string which contains more than one character.");if("string"!=typeof a.user_id||!a.user_id)throw new TypeError("User ID must be a string which contains more than one character.");this._access_token=a.access_token,this._user_id=a.user_id,this._default_field_list=a.default_field_list||[],this._default_limit=a.default_limit||500}function e(c,d,f){return(new b.Queue).push(function(){return a.util.ajax({type:"GET",url:c})}).push(function(a){return JSON.parse(a.target.responseText)},function(b){throw new a.util.jIOError("Getting feed failed "+b.toString(),b.target.status)}).push(function(a){if(0===a.data.length)return d;var b,c,g={};for(b=0;b<a.data.length;b+=1){for(g.id=a.data[b].id,g.value={},c=0;c<f.length;c+=1)g.value[f[c]]=a.data[b][f[c]];d.push(g),g={}}return e(a.paging.next,d,f)})}var f="https://graph.facebook.com/v2.9/{+post_id}?fields={+fields}&access_token={+access_token}",g=c.parse(f),h="https://graph.facebook.com/v2.9/{+user_id}/feed?fields={+fields}&limit={+limit}&since={+since}&access_token={+access_token}",i=c.parse(h);d.prototype.get=function(c){var d=this;return(new b.Queue).push(function(){return a.util.ajax({type:"GET",url:g.expand({post_id:c,fields:d._default_field_list,access_token:d._access_token})})}).push(function(a){return JSON.parse(a.target.responseText)})},d.prototype.buildQuery=function(a){var b=this,c=[],d=this._default_limit,f={user_id:this._user_id,limit:d,access_token:this._access_token};return a.include_docs&&(c=c.concat(b._default_field_list)),a.select_list&&(c=c.concat(a.select_list)),a.limit&&(d=a.limit[1]),f.fields=c,f.limit=d,e(i.expand(f),[],c).push(function(b){return a.limit?b.slice(a.limit[0],a.limit[1]):b})},d.prototype.hasCapacity=function(a){var b=["list","select","include","limit"];return-1!==b.indexOf(a)?!0:void 0},a.addStorage("facebook",d)}(jIO,RSVP,UriTemplate);