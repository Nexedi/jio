...
(function (jIO, RSVP, Blob, QUnit) {
  ...
  module("revisionStorage.post", {
    setup: function () {
      // create storage of type "revision" with memory as substorage
      ...
      this.not_revision = jIO.createJIO({
        type: "query",
        sub_storage: {
          type: "uuid",
          sub_storage: {
  ...
  test("Verifying simple post works",
    function () {
      ...
      var jio = this.jio,
        ...
        not_revision = this.not_revision,
        timestamps;
      ...
      return jio.post({title: "foo0"})
        ...
        .push(function (res) {
          deepEqual(res, {
            title: "foo1"
          }, "revision storage only retrieves latest version");
        })
        .push(function () {
        ...
        .push(function () {
          return revision.allDocs({select_list: ["title"]});
        })
        .push(function (res) {
  ...
  module("revisionStorage.attachments", {
    setup: function () {
      // create storage of type "revision" with memory as substorage
      var dbname = "db_" + Date.now();
        ...
        .push(function () {
          ...
          function (error) {
            ...
            deepEqual(error.message,
              "revisionStorage: cannot find object '" + timestamps[0] + "'",
              "Error caught by revision storage correctly");
      ...
      jio.put("doc", {title: "foo0"})
        ...
        .push(function () {
          ...
          function (error) {
            ...
            deepEqual(error.message,
              "revisionStorage: cannot find object 'doc' (removed)",
              "Error is handled by revisionstorage.");
          })
        .fail(function (error) {
          //console.log(error);
          ok(false, error);
      ...
      jio.put("doc", {title: "foo0"})
        ...
        .push(function (results) {
          var promises = results.data.rows.map(function (data) {
            return not_revision.get(data.id);
          });
    ...
    function () {
      ...
      jio.put("doc", {title: "foo0"}) // 0
        ...
        .push(function (results) {
          ...
          return revision.allAttachments(timestamps[0]);
        })
        .push(function (results) {
          deepEqual(results, {}, "First version of document has 0 attachments");

          return revision.allAttachments(timestamps[1]);
        })
        .push(function (results) {
          deepEqual(results, {
            data: blob1,
          ...
          return revision.allAttachments(timestamps[2]);
        })
        .push(function (results) {
          deepEqual(results, {
            data: blob1
          }, "Removed attachment does not show up in allAttachments");
          return revision.allAttachments(timestamps[3]);
        })
        .push(function () {
          ok(false, "This query should have thrown a 404 error");
        },
          function (error) {
            ...
            deepEqual(error.status_code,
              ...
              "allAttachments of a removed document throws a 404 error");
            deepEqual(error.message,
              "revisionStorage: cannot find object '" + timestamps[3] +
                "' (removed)",
              "Error is handled by revisionstorage.");
          })
        .push(function () {
          return revision.allAttachments(timestamps[4]);
        })
        .push(function (results) {
          deepEqual(results, {
            data: blob11
        ...
        .push(function () {
          return revision.allAttachments("not-a-timestamp-or-doc_id");
        })
        .push(function () {
          ok(false, "This query should have thrown a 404 error");
        },
          function (error) {
            ...
            deepEqual(error.status_code,
              ...
              "allAttachments of a removed document throws a 404 error");
            deepEqual(error.message,
              "revisionStorage: cannot find object 'not-a-timestamp-or-doc_id'",
              "Error is handled by revisionstorage.");
          })
        .fail(function (error) {
          //console.log(error);
    ...
    function () {
      ...
      jio.remove("doc")
        ...
        .push(function () {
          ...
          deepEqual(error.message,
            "revisionStorage: cannot find object 'doc' (removed)",
            "Error is handled by revision storage before reaching console");
        })
        .push(function () {
    ...
    function () {
      ...
      jio.put("not_doc", {})
        ...
        .push(function () {
          ...
          deepEqual(error.message,
            "revisionStorage: cannot find object 'doc'",
            "Error is handled by revision storage before reaching console");
        })
        .fail(function (error) {
          //console.log(error);
    ...
    function () {
      ...
      jio.put("not_doc", {})
        ...
        .push(function () {
          ...
          deepEqual(error.message,
            "revisionStorage: cannot find object '" + timestamp + "'",
            "Error is handled by revision storage before reaching console");
        })
    ...
    function () {
      ...
      jio.put("doc", {title: "version0"})
        ...
        .push(function () {
          ...
          return revision.get(timestamps[0]);
        })
        .push(function (result) {
          deepEqual(result, {
            title: "version0"
          }, "Get document from revision storage");
          return not_revision.get(
            timestamps[0]
          );
        })
        .push(function (result) {
          ...
          }, "Get document from non-revision storage");
        })
        .push(function () {
  ...
  test("Updating a document with include revisions",
    function () {
      ...
      jio.put("doc", {title: "version0"})
        .push(function () {
          return revision.put("doc", {title: "version1"});
        })
        .push(function () {
          return not_revision.allDocs({sort_on: [["timestamp", "ascending"]]});
        })
        .push(function (results) {
          t_id = results.data.rows[0].id;
          return revision.put(t_id, {title: "version0.1"});
        })
        .push(function () {
          return jio.put(t_id, {title: "label0"});
        })
        .push(function () {
          return revision.put("1234567891012-abcd", {k: "v"});
        })
        .push(function () {
          return not_revision.allDocs({
            select_list: ["timestamp"]
    ...
    function () {
      ...
      return jio.put("doc", {title: "t0", subtitle: "s0"})
        ...
        .push(function (result) {
          ...
          return revision.get(timestamps[1]);
        })
        .push(function (result) {
          deepEqual(result, {
            title: "t1",
          ...
          return revision.get(timestamps[2]);
        }, function (err) {
          ok(false, err);
        })
        .push(function (result) {
          ...
          return revision.get(timestamps[3]);
        }, function (err) {
          ok(false, err);
        })
        .push(function () {
          ok(false, "This should have thrown a 404 error");
          return revision.get(timestamps[4]);
        },
          function (error) {
            ok(error instanceof jIO.util.jIOError, "Correct type of error");
            deepEqual(error.status_code,
    ...
    function () {
      ...
      jio.put("bar", {"title": "foo0"})
        ...
        .push(function (results) {
          ...
          return not_revision.get(results.data.rows[0].id);
        })
        .push(function (results) {
          deepEqual(results, {
            doc_id: "bar",
    ...
    function () {
      ...
      jio.put("doc", {"title": "foo0"})
        ...
        .push(function (res) {
          ...
          return not_revision.allDocs({select_list: ["title"]});
        })
        .push(function (results) {
          edit_log = results.data.rows;
          return revision.get(edit_log[0].id);
        })
        .push(function (result) {
          deepEqual(result, {title: "foo0"});
          return revision.get(edit_log[1].id);
        })
        .push(function (result) {
          deepEqual(result, {title: "foo0"});
          return revision.get(edit_log[2].id);
        })
        .push(function (result) {
          deepEqual(result, {title: "foo0"});
        })
  ...
  module("revisionStorage.allDocs", {
    setup: function () {
      // create storage of type "revision" with memory as substorage
      ...
      jio.put("doc", {title: "version0"})
        ...
        .push(function (results) {
          ...
          equal(results.data.total_rows,
            1,
            "Exactly one result returned");
          return not_revision.get(timestamp);
        })
        .push(function (result) {
          deepEqual(result, {
            doc_id: "doc",
            ...
            "When a different type of storage queries revisionstorage, all " +
    ...
    function () {
      ...
      jio.put("doc", {
        ...
        .push(function (results) {
          ...
          ], "Full version revision is included.");
    ...
    function () {
      ...
      jio.put("document", {title: "foo"})
        ...
        .push(function (results) {
          ...
          return not_revision.allDocs({select_list: ["doc"]});
        })
      ...
      jio.put("doc a", {title: "foo0"})
        ...
        .push(function (results) {
          deepEqual(results.data.rows, [
            ...
            "Only specified document revision revision is returned"
            );
        })
        .fail(function (error) {
          //console.log(error);
  ...
  test("Adding second query storage on top of revision",
    function () {
      stop();
      expect(1);
      var jio = this.jio;
  ...
  module("revisionStorage.Full-Example", {
    setup: function () {
      // create storage of type "revision" with memory as substorage
      var dbname = "db_" + Date.now();
      this.blob1 = new Blob(['a']);
  ...
  test("Retrieving revision with attachments",
    function () {
      stop();
      expect(1);
      var jio = this.jio,
  ...
  test("Retrieving revision with attachments with removals",
    function () {
      stop();
      expect(2);
      var jio = this.jio,
  ...
  test("Verifying pack works with fixed timestamp",
    function () {
      ...
      return jio.allDocs()
        ...
        .push(function () {
          return not_revision.allDocs({sort_on: [["timestamp", "descending"]]});
        })
        .push(function (results) {
          timestamp = results.data.rows[0].id;
