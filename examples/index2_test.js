...
/*  function randomi(limit) {
  ...
  function get_fake_data_values2(i) {
    if (i === 0 || i === 1 || i === 2) {
      return {'url': 'https://renderjs.com', 'name': 'erp5', 'user': 'preet'};
    }
    if (i === 3 || i === 4) {
      return {'url': 'https://erp5.com', 'name': 'erp5', 'user': 'test'};
    }
    if (i === 5 || i === 6 || i === 7) {
    ...
    .declareService(function () {
      ...
      return RSVP.all(promise_list)
        .then(function () {
          ...
          return storage.allDocs({query: 'name:erp5'})
            .then(function (result) {
              ...
              return storage.allDocs({query: 'name:jio OR name:erp5'})
                .then(function (result) {
                  ...
                  return storage.allDocs({query: 'user:string OR name:nexedi'})
                    .then(function (result) {
                      ...
                      return storage.allDocs({query: 'user:string'})
                        .then(function (result) {
